...
<section class="cards-wrapper-four">
  ...
  <div class="card-four-grid-space">
    ...
    <a class="card-four" href="theory/dbVisualizerTheory1.jsp" style="--bg-img: url('https://images1-focus-opensocial.googleusercontent.com/gadgets/proxy?container=focus&resize_w=1500&url=https://codetheweb.blog/assets/img/posts/links-images-about-file-paths/cover.jpg')">
      <div>
