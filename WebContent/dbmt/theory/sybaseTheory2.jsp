        ...
        <div class="card-group-control card-group-control-right">
            <div class="card mb-2 w-100">
                ...
                <div id="question2" class="collapse show" style="">
                    <div class="card-body"> Coalesce is also available in Sybase This functions evaluates the listed expressions and returns the first nonÂ¬null value. If all the expressions are null, coalesce returns null 
USAGE: coalesce(expression, expression [, expression]â¦)
EXAMPLE: coalesce(initialqty,finalqty,middleqty)
Returns the first occurrence of a nonÂ¬NULL value in either the initialqty or finalqty or middleqty.
                     </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
...
Any errors introduced by the DBA will not interfere with the System Administratorâs job. 
...
1. An âappendÂ¬onlyâ table to which every transaction must write.
...
3. Work tables.
4. Temporary tables.
5. Tables that are already partitioned. However, you can unpartition and then reÂ¬partition tables to change the number of partitions.
                     </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
...
By the way, SyBooks is wrong when it states that the above needs to be reset when ASE is rebooted. This is a permanent setting.
 To undo it:
dbcc tune(ascinserts, 0, âmy_tableâ)
                     </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
...
This is one of the ways to eliminate duplicates.
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Can I Run Any TransactÂ¬sql Command On A Partitioned Table In Sybase? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question13" class="collapse show" style="">
                    <div class="card-body">  No. Once you have partitioned a table, you cannot use any of the following TransactÂ¬SQL commands on the table until you unpartition it:
1. drop table
2. sp_placeobject
3. truncate table
...
o	Make sure the Statistics are up-to-date: â Run update statistics on the tables in question if the data in these tables is changed drastically.
o	Check Search Arguments: â If possible avoid inequality operator. Avoid operations on columns and constant expressions that can not be evaluated at query compile time.
...
There are 2 types of indexes: Clustered and Non clustered.
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question16" class="collapse show" style="">
                    <div class="card-body">  Clustered Index: â Data is physically sorted. The bottom or leaf level of a clustered index contains the actual data pages of the table. So there can be only one clustered index per table.
Non-Clustered Index: â With a non-clustered index, the physical order of the rows is not the same as their indexed order. The leaf level of a non-clustered index contains pointers to rows on data pages. More precisely, each leaf page contains an indexed value and a pointer to the row with that value. Up to 249 non-clustered indexes are allowed in a table.
                    </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
