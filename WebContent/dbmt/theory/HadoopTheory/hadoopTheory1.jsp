        ...
        <div class="card-group-control card-group-control-right">
            <div class="card mb-2 w-100">
                ...
                <div id="question1" class="collapse show" style="">
                    <div class="card-body">  When “Big Data” emerged as a problem, Apache Hadoop evolved as a solution to it. Apache Hadoop is a framework which provides us various services or tools to store and process Big Data. It helps in analyzing
Big Data and making business decisions out of it, which can’t be done efficiently and effectively using traditional systems.main components of Hadoop, i.e.:
Storage unit– HDFS (NameNode, DataNode)
Processing framework– YARN (ResourceManager, NodeManager).</div>
                </div>
            </div>
                 <div class="card mb-2 w-100">
                <div class="card-header">
...
HDFS uses commodity hardware which is cost-effective, whereas a NAS is a high-end storage devices which includes high cost. </div>
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question5" class="collapse show" style="">
                    <div class="card-body"> n Hadoop 1.x, “NameNode” is the single point of failure. In Hadoop 2.x, we have Active and Passive “NameNodes”. If the active “NameNode” fails, the passive “NameNode” takes charge. Because of this, high availability can be achieved in Hadoop 2.x.
Also, in Hadoop 2.x, YARN provides a central resource manager. With YARN, you can now run multiple applications in Hadoop, all sharing a common resource. MRV2 is a particular type of distributed application that runs the MapReduce framework on top of YARN. Other tools can also perform data processing via YARN, which was a problem in Hadoop 1.x. </div>
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What are active and passive “NameNodes”? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question6" class="collapse show" style="">
                    <div class="card-body"> In HA (High Availability) architecture, we have two NameNodes – Active “NameNode” and Passive “NameNode”.
...
When the active “NameNode” fails, the passive “NameNode” replaces the active “NameNode” in the cluster. Hence, the cluster is never without a “NameNode” and so it never fails. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                ...
                <div id="question7" class="collapse show" style="">
                    <div class="card-body">  One of the most attractive features of the Hadoop framework is its utilization of commodity hardware. However, this leads to frequent “DataNode” crashes in a Hadoop cluster. Another striking feature of Hadoop Framework is the ease of scale in accordance with the rapid growth in data volume. Because of these two reasons, one of the most common task of a Hadoop administrator is to commission (Add) and decommission (Remove) “Data Nodes” in a Hadoop Cluster.</div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
...
When the first client contacts the “NameNode” to open the file for writing, the “NameNode” grants a lease to the client to create this file. When the second client tries to open the same file for writing, the “NameNode” will notice that the lease for the file is already granted to another client, and will reject the open request for the second client. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
