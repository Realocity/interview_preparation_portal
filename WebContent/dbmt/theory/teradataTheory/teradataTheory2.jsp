            ...
            <div class="card mb-2 w-100">
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question4" class="collapse show" style="">
                    <div class="card-body">  Amp basically consists of a Database Manager Subsystem and is capable of performing the operations mentioned below. • Performing DML • Performing DDL • Implementing Aggregations and Joins. • Releasing and applying locks, etc.</div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question7" class="collapse show" style="">
                    <div class="card-body">  A Parser: - • Checks semantics errors • Checks syntactical errors • Checks object existence.</div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question13" class="collapse show" style="">
                    <div class="card-body"> There are basically four types of LOCKS that fall under Teradata. These are: - • Read Lock • Access Lock • Exclusive Lock • Write Lock. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                ...
                <div id="question14" class="collapse show" style="">
                    <div class="card-body"> Table Level – All the rows that are present inside a table will certainly be locked. • Database Level Lock – All the objects that are present inside the database will be locked. • Row Hash Level Lock – Only those rows will be locked which are corresponding to the particular row. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question18" class="collapse show" style="">
                    <div class="card-body"> SMALLINT – 2 Bytes – 16 Bites -> -32768 to 32767 BYTEINT – 1 Bytes – 8 Bits -> -128 to 127 INTEGER – 4 Bytes – 32 Bits -> -2,147,483,648 to 2,147,483,647 </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question20" class="collapse show" style="">
                    <div class="card-body">  A database is basically passive, whereas a user is active. • A database primarily stores all the objects of database, whereas a user can store any object whether that is a macro, table, view, etc. • Database does not has password while the user has to enter password.</div>
                </div>
            </div>
