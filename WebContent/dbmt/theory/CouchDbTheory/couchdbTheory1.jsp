...
3.	In addition, the Couchbase server features an easy and simple UI. One can install, manage, and expand the usage. The server doesn't require the necessity of maintaining or creating schemas. It also doesn’t require normalizing or even tuning the database.
