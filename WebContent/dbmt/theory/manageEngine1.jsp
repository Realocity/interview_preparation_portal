...
<title>Manage Engine Theory</title>
            ...
            <div class="card mb-2 w-100">
                ...
                <div class="card-header">
                    ...
                    <a class="text-muted text-uppercase" data-toggle="collapse" href="#question2">
                     <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What is the difference between ManageEngineÂ® OpManager and ManageEngineÂ® Applications Manager? Can they be integrated? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
...
Yes, Applications Manager and OpManager can be integrated by using Network Monitoring Connector. You can monitor availability and performance of routers, switches and firewalls through a single console. </div>
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question4" class="collapse show" style="">
                    <div class="card-body"> ManageEngineÂ® Applications Manager is available as Windows and Linux downloads. Right now, we dont support Solaris version. But you can monitor the performance of solaris host by running Applications Manager in a windows/linux host. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
...
For eg., If you want to monitor 100 SQL Server installations in your network, the 100 SQL Servers will be considered as 100 monitors.
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question6" class="collapse show" style="">
                    <div class="card-body"> <br>⦿	If SNMP is enabled in that application, you can use SNMP monitor to monitor that particular application. Also if you have Mib for your application, you can upload that Mib to Applications Manager and add the required attributes to be monitored.
<br>⦿	If your applications use java and exposes data through JMX or it uses JDK 1.5 and exposes data through JMX, you can use JMX [MX4J / JDK1.5] monitor to monitor your application and also add required attributes for monitoring.
<br>⦿	If the custom application is running in a particular TCP port, you can use Service monitor to monitor the port and check for availability of that port. [Service Monitoring]
<br>⦿	If the application is web based application ( like IIS or Apache ), you can use HTTP-URLs and HTTP-URL Sequence monitoring to monitor the URLs for their availability. [Website Monitoring]
<br>⦿	If you have a script in Applications Manager machine which can monitor your application, Applications Manager server can execute this script periodically using Script monitor. It will also generate reports and escalate alarms according to the results obtained. [Script Monitoring]
<br>⦿	If you have a web application using JDK 1.5, you can use Web Transaction Monitor to monitor the end to end details about the application. [Web Transactions].
<br>⦿	Windows performance counter values can be added and monitored as attributes. Applications Manager uses WMI for monitoring Windows Performance Counters. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                ...
                <div id="question7" class="collapse show" style="">
                    <div class="card-body"> ManageEngineÂ® Applications Manager monitors the overall CPU usage of the server (not individual CPUs). Win32_PerfRawData_PerfOS_Processor class is used to get the required CPU data in WMI mode of monitoring. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
