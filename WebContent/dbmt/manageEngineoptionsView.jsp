...
<section class="cards-wrapper-four">
  ...
  <div class="card-four-grid-space">
    ...
    <a class="card-four" href="theory/manageEngine1.jsp" style="--bg-img: url('https://images1-focus-opensocial.googleusercontent.com/gadgets/proxy?container=focus&resize_w=1500&url=https://codetheweb.blog/assets/img/posts/links-images-about-file-paths/cover.jpg')">
      <div>
        <h1>Links, images and about file paths</h1>
        <p>Learn how to use links and images along with file paths…</p>
        <div class="date">THEORY</div>
        <div class="tags">
          <div class="tag">Manage Engine</div>
        </div>
      </div>
    </a>
  </div>
