	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">MICROSOFT ACCESS-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         {
	            text: "Microsoft Access is a _____?",
	            responses: [
	               { text: "Network Database Model" },
	               { text: "RDBMS", correct: true },
	               { text: "ORDBMS" },
	               { text: "OODBMS" }
	            ]
	         },
	         {
	            text: "Which of the following is not a type of Microsoft access database object?",
	            responses: [
	               { text: "Macros" },
	               { text: "Modules" },
	               { text: "Worksheets", correct: true },
	               { text: "Table" }
	            ]
	         },
	         {
	            text: "A subset of characters within a data field is known as?",
	            responses: [
	               { text: "Byte" },
	               { text: "File" },
	               { text: "Record" },
	               { text: "Data string" , correct: true}
	            ]
	         },
	         {
	            text: "Press _____ to quit MS Access?",
	            responses: [
	               { text: "Tab +F4" },
	               { text: "Esc+ W" },
	               {
	         ...
	         {
	            text: "____ is not a valid data type in MS Access?",
	            responses: [
	               { text: "Auto number " },
	               {
	                  text: "Currency"
	         ...
	         {
	            text: "What is the maximum length a text field can be? ",
	            responses: [
	               { text: "75 " },
	               { text: " 120" },
	               {
	         ...
	         {
	            text: "In Access, ____ are used to store the data? ",
	            responses: [
	               { text: "Report" },
	               { text: "Form"},
	         ...
	         },
	         {
	            ...
	            responses: [
	               {
	                  text: "Table query wizard"
	               },
	               { text: "Simple query wizard " , correct: true },
	               { text: "Simple filer wizard" },
	               { text: "Database wizard" }
	            ]
	         },
	         {
	            text: "\ To create \ \ primary\ key for  \ a table when \ in design view?",
	            responses: [
	               { text: "Type PRIMARY in field type box when creating required field " },
	               { text: "Mark the Primary check box in field name of required field" },
	               { text: "Click the Primary Key button in Design ribbon when the cursor is in required field", correct: true },
