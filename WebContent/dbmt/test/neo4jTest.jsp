	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">NEO4J-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         ...
	         {
	            text: "Programming language used in Neo4J?",
	            responses: [
	               { text: "C" },
	               { text: "C++" },
	         ...
	         {
	            text: "Which of the following are an Advantages of Neo4j?",
	            responses: [
	               { text: "Flexible data model" },
	         ...
	         {
	            text: "Which of the following not true about Neo4j Property Graph Data Model?",
	            responses: [
	               { text: "Properties are key-value pairs " },
	               {
	                  text: "The model does not represents data in Nodes, Relationships and Properties", correct: true
	               },
	               { text: "Relationships have directions: Unidirectional and Bidirectional" },
	               { text: "Relationships connects nodes" }
	            ]
	         },
	         {
	            text:
	               "CQL stands for?",
	            responses: [
	               { text: "Command Query Language" },
	               { text: "Clause Query Language" },
	               { text: "Cypher Query Language", correct: true },
	               { text: "Create Query Language" }
	            ]
	         },
	         {
	            text: "Which clause is used to find the starting points through the legacy indexes? ",
	            responses: [
	               { text: " OPTIONAL MATCH" },
	         ...
	         {
	            text: "Which clause is used to delete nodes and relationships or paths etc. from the graph? ",
	            responses: [
	         ...
	         {
	            text: "\ Which\ \ of the \ following \ is not a \ Neo4J CQL command?",
	            responses: [
	               { text: "Create " },
	               { text: "Match" },
	               { text: "Delete" },
