	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">CLOUDDERA-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         {
	            text: "___________ is the world’s most complete, tested, and popular distribution of Apache Hadoop and related projects?",
	            responses: [
	               { text: "MDH" },
	               { text: "CDH", correct: true },
	               { text: "ADH" },
	               { text: "BDH" }
	            ]
	         },
	         {
	            ...
	            responses: [
	               { text: "Cloudera is also a sponsor of the Apache Software Foundation"},
	               { text: "CDH is 100% Apache-licensed open source and is the only Hadoop solution to offer unified batch processing, interactive SQL, and interactive search, and role-based access controls" },
	               { text: "More enterprises have downloaded CDH than all other such distributions combined" },
	               { text: "All of the mentioned", correct: true }
	            ]
	         },
	         {
	            text: "Cloudera ___________ includes CDH and an annual subscription license (per node) to Cloudera Manager and technical support?",
	            responses: [
	         ...
	         {
	            text: "Cloudera Express includes CDH and a version of Cloudera ___________ lacking enterprise features such as rolling upgrades and backup/disaster recovery?",
	            responses: [
	               { text: "Enterprise" },
	               { text: "Express" },
	               {
	         ...
	         },
	         {
	            ...
	            responses: [
	               { text: "CDH contains the main, core elements of Hadoop " },
	               {
	                  text: "In October 2012, Cloudera announced the Cloudera Impala project"
	               },
	               { text: "CDH may be downloaded from Cloudera’s website at no charge" },
	         ...
	         {
	            text: "__________ is a online NoSQL developed by Cloudera? ",
	            responses: [
	               { text: " HCatalog" },
	               { text: "Hbase ", correct: true },
	               {
	                  text: "Imphala"
	               },
	               { text: "Oozie" }
	         ...
	         {
	            text: "_______ is an open source set of libraries, tools, examples, and documentation engineered? ",
	            responses: [
	         ...
	         },
	         {
	            ...
	            responses: [
	               ...
	               { text: "libhadoop ", correct: true },
	               { text: "libhad"},
	               { text: "none of the mentioned" }
	            ]
	         },
	         {
	            text: "\ CDH process\ \ and control\ sensitive \ data\ and facilitate __________?",
	            responses: [
	               { text: "multi-tenancy " , correct: true},
	               { text: "flexibilty" },
	               { text: "scalability" },
	               { text: "all of the mentioned" }
	            ]
