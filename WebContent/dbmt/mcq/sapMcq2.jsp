...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.11 How many lists can exist in parallel in an interactive reporting?</p>
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.12 What are the check tables and value tables? </p>
        <div class="options py-3">
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.13 What are presentation and application servers in SAP? </p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.14 What is the difference between Synchronous and Asynchronous updates?  </p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.15 What are the main events interactive reports have?  </p>
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.16  Is Session Method, Asynchronous or Synchronous?</p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.17 Which data type cannot be used to define parameters?</p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.18 What is the maximum number of watchpoints that can exist at one time?</p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.19 When starting the Debugger, what circumstance causes the runtime error DEBUGGINGNOTPOSSIBLE?</p>
        <div class="options py-3"> 
...
defined by the profile parameter rdisp/wpdbugmaxno.<input type="radio" name="radio"> <span class="crossmark"></span> </label> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.20 The ABAP keyword for adding authorizations to a program is ____.</p>
        <div class="options py-3"> 
