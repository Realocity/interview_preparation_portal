...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.1 Which of the following correctly describes scalar data types in Perl?</p>
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.3 Which of the following is correct about Hashes?</p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.6 Which of the following operator returns true if the left argument is stringwise greater than the right argument? </p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.8 Parameters of a function can be acessed inside the function using the special array @_?</p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.9 Which of the following function opens a file in writing mode after truncating the file?</p>
        <div class="options py-3"> 
    ...
    <div id='pagination'>
     <div><span class="page current">4</span>
				...
				<a class='page next' href='Perlmcq5.jsp' title='Next'>&raquo;</a>
				</div>
				</div>
				<center>
</div>
