...
<div class="wrapper bg-white rounded">
    ...
    <div class="content"> 
     ...
     <div class="content"> 
        ...
        <div class="options py-3">
         <label class="rounded p-2 option"> awk’s built-in functions can be categorised into three categories: numeric, string and I/O<input type="radio" name="radio"> <span class="crossmark"></span> </label> 
