...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        ...
        <label class="rounded p-2 option"> 1986 <input type="radio" name="radio"> <span class="checkmark"></span> </label> 
        <label class="rounded p-2 option"> 1987<input type="radio" name="radio"> <span class="crossmark"></span> </label> </div>
    ...
    <div class="content"> 
        ...
        <div class="options py-3">
         ...
         <label class="rounded p-2 option"> A&B </stylesheet> <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
    ...
    <div class="content"> 
        ...
        <label class="rounded p-2 option"> Char <input type="radio" name="radio"> <span class="checkmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option">  ! <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> _ <input type="radio" name="radio"> <span class="checkmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> UNIX<input type="radio" name="radio"> <span class="checkmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> !<input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> _<input type="radio" name="radio"> <span class="crossmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> Internetworking operating system<input type="radio" name="radio"> <span class="checkmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> contains both compiler (swiftc and objective c) <input type="radio" name="radio"> <span class="checkmark"></span> </label> 
