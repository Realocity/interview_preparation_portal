...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.1 how should you order routes?</p>
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.2 what should you write in routes.rb to give meaning to http://mebay.com/ads/3?</p>
        <div class="options py-3">
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.3 to add login security, which two pieces of code do you need?</p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.4 how do partials look compared to regular erb files? </p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.5 how does "rake" differ from "ruby"? </p>
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.6 why should partials generally use local variables? </p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.7 do models have singular or plural names?</p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.8 how does rake tell which migrations have been run and which have not?</p>
        <div class="options py-3"> 
        <label class="rounded p-2 option"> rails generate migration AddPhoneToTickets phone:string  <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.9 how does Rails choose to correct format to generate?</p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.10 how do you express error messages in a form (do |f|)?</p>
        <div class="options py-3"> 
    ...
    <div id='pagination'>
     <div><span class="page current">4</span>
				...
				<a class='page next' href='ruby5.jsp' title='Next'>&raquo;</a>
				</div>
				</div>
				<center>
</div>
