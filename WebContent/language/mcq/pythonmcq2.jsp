...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.1 Are nested if-else are allowed in Python?</p>
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.2  Python allows string slicing. What is the output of below code: s='cppbuzz chicago' 
print(s[3:5])</p>
        <div class="options py-3">
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.3 class test: def __init__(self): print "Hello World" def __init__(self): print "Bye 
World" obj=test()
        	</p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.4 The format function, when applied on a string returns : </p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.5 Which statement is correct....??
         </p>
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.6 What is the maximum possible length of an identifier? </p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.7  Which one of the following is not a python's predefined data type?</p>
        <div class="options py-3">
         <label class="rounded p-2 option"> List<input type="radio" name="radio"> <span class="crossmark"></span> </label> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.8 What will be the output of 7^10 in python?</p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.9 19 % 2 in python</p>
        <div class="options py-3"> 
        <label class="rounded p-2 option">  2<input type="radio" name="radio"> <span class="crossmark"></span> </label> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.10  Which of the following has more precedance?
        </p>
        <div class="options py-3"> 
    ...
    <div id='pagination'>
     <div><span class="page current">2</span>
				...
				<a class='page next' href='pythonmcq3.jsp' title='Next'>&raquo;</a>
				</div>
				</div>
				<center>
</div>
