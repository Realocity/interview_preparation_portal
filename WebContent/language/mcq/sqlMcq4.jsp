...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.31 Which of the following is the basic approaches for joining tables?</p>
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.32 Why we need to create an index if the primary key is already present in a table?</p>
        <div class="options py-3">
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.33 Group of operations that form a single logical unit of work is known as</p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.34 Shared locks are applied while performing </p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.35 Sequence can generate </p>
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.36 A sequence in SQL can generate a maximum number: </p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.37 Which of the following is the correct order of a SQL statement? </p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.38 What is the difference between a PRIMARY KEY and a UNIQUE KEY?</p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.39 Which of the following are the synonyms for Column and ROW of a table?
1.	Row = [Tuple, Record]
...
4.	Columns = [Field, Record] </p>
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.40 Which operator is used to compare the NULL values in SQL?</p>
        <div class="options py-3"> 
