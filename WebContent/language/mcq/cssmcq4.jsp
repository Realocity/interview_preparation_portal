...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.1 Which type of CSS is used in the below code? <br>
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.2 Which of the following CSS property specifies the origin of the background-image? </p>
        <div class="options py-3">
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.3 The CSS property used to set the maximum width of the element's content box is </p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.4 Which if the following CSS function allows us to perform calculations? </p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.5 The CSS property used to set the maximum height of the element's content box  </p>
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.6 The CSS property used to set the minimum width of the element's content box  </p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.7 Which of the following CSS property is used to represent the overflowed text which is not visible to the user? </p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.8 The CSS property which is used to define the set the difference between two lines of your content is  </p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.9 The CSS property which is used to define the set the difference between two lines of your content is  </p>
        <div class="options py-3"> 
        <label class="rounded p-2 option"> min-height property <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> max-height property <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option">line-height property <input type="radio" name="radio"> <span class="checkmark"></span> </label> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.10 None of the above </p>
        <div class="options py-3"> 
