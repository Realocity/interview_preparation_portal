...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        ...
        <label class="rounded p-2 option"> friend<input type="radio" name="radio"> <span class="crossmark"></span> </label> </div>
    ...
    <div class="content"> 
        ...
        <div class="options py-3">
         ...
         <label class="rounded p-2 option"> function  <input type="radio" name="radio"> 
    ...
    <div class="content"> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> Namespaces <input type="radio" name="radio"> <span class="checkmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> Application <input type="radio" name="radio"> <span class="checkmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> Visual Basic 2005 <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> Today <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> Procedures <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> Variables <input type="radio" name="radio"> <span class="crossmark"></span> </label> </div> 
    </div> 
