...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        ...
        <label class="rounded p-2 option"> Argument<input type="radio" name="radio"> <span class="crossmark"></span> </label> </div>
    ...
    <div class="content"> 
        ...
        <div class="options py-3">
         ...
         <label class="rounded p-2 option"> __xyz__ = 5 </stylesheet> <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
    ...
    <div class="content"> 
        ...
        <label class="rounded p-2 option"> It indicates a private variable of a class<input type="radio" name="radio"> <span class="checkmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> x,y,z,p = 5000, 6000, 7000, 8000 <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> Division, Multiplication, Addition, Subtraction, Parentheses, Exponential<input type="radio" name="radio"> <span class="crossmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> Subtraction and Division <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> Power and Division <input type="radio" name="radio"> <span class="crossmark"></span> </label> </div> 
    </div> 
