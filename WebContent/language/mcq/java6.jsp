...
<div class="wrapper bg-white rounded">
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.2 In a class definition, the special method provided to be called to create an instance of that class is known as a/an </p>
        <div class="options py-3">
...
Which of them is correct?
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.4 Consider the following statements:
...
Identify the correct statement from the following:
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.6 Consider the following statement(s) about Java:
...
Which of them is correct?
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.7 Consider the following data types in Java :
...
Which of them are simple data types?
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.8 For what values respectively of the variables gender and age would the Java expression gender == 1 && age >= 65 become true?</p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.9 Consider the following Java program :
