...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        ...
        <label class="rounded p-2 option"> Scripts <input type="radio" name="radio"> <span class="checkmark"></span> </label> 
    ...
    <div class="content"> 
        ...
        <div class="options py-3">
         ...
         <label class="rounded p-2 option"> Terminal </stylesheet> <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
         <label class="rounded p-2 option"> GCC Compiler <input type="radio" name="radio"> 
    ...
    <div class="content"> 
        ...
        <label class="rounded p-2 option"> Stats<input type="radio" name="radio"> <span class="crossmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> Guided Used Interface <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> Probability <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> For more packages <input type="radio" name="radio"> <span class="crossmark"></span> </label> </div> 
    </div> 
