...
<div class="wrapper bg-white rounded">
    ...
    <div class="content"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.4 If you don’t specify ASC or DESC after a SQL ORDER BY clause, the following is used by default ____ </p>
        <div class="options py-3">
