...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.1 Which of the following is not a kind of inheritance?</p>
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.2 What will happen if "In a C++ program a class has no name"?</p>
        <div class="options py-3">
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.3 Which type of approach is used by the C++ language? </p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.4  Which of the following concept refers to adding new components to the program at the run time?</p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.5 How can one implement the compile-time Polymorphism in the C++ programming language? </p>
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.6 How can one implement the run-time Polymorphism in the C++ programming language? </p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.7 Which of the following offers a programmer the facility of using a specific class object into other classes?</p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.8 Which one of the following cannot be a friend in C++ languages?</p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.9 How are the references different from the pointer?</p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.10 Among the following given options, which can be considered as a member of a class?</p>
        <div class="options py-3"> 
    ...
    <div id='pagination'>
     <div><span class="page current">6</span>
				...
				<a class='page next' href='cpp7.jsp' title='Next'>&raquo;</a>
				</div>
				</div>
				<center>
</div>
