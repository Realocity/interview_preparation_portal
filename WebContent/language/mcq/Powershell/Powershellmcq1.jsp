...
<div class="wrapper bg-white rounded">
    ...
    <div class="content"> 
     ...
     <div class="content"> 
        ...
        <div class="options py-3">Text editor with “Hello world” scripted <label class="rounded p-2 option">  <input type="radio" name="radio"> <span class="checkmark"></span> </label> 
        <label class="rounded p-2 option"> Text editor with “Hello” scripted <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
