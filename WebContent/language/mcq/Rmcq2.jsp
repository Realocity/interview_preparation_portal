...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.1 What is output of getOption(“defaultPackages”) in R studio?</p>
    ...
    <div class="content"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.4 What is the mode of ‘a’ in the following R code?<br>a <- c(1,” a”, FALSE) </p>
        <div class="options py-3">
