...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        ...
        <label class="rounded p-2 option"> brightness()<input type="radio" name="radio"> <span class="checkmark"></span> </label> </div>
    ...
    <div class="content"> 
        ...
        <div class="options py-3">
         ...
         <label class="rounded p-2 option"> Dark() <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
         <label class="rounded p-2 option"> Light() </stylesheet> <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
         <label class="rounded p-2 option"> Brightness() <input type="radio" name="radio"> 
    ...
    <div class="content"> 
        ...
        <label class="rounded p-2 option">Custom() <input type="radio" name="radio"> <span class="checkmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> black() <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> saturate() <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> none <input type="radio" name="radio"> <span class="crossmark"></span> </label> </div> 
    </div> 
     <div class="content"> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> matrix3d() <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> light <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> lighter <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> dark <input type="radio" name="radio"> <span class="checkmark"></span> </label> </div> 
    </div> 
