...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.1 flag is a bool type variable, the following if expression conforms to the coding specification is ()</p>
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.2 value is an integer variable, the following if expression conforms to the coding specification is ()</p>
        <div class="options py-3">
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.3 On the wrong design of the function return value, the following statement is correct () </p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.4 About the abnormal design, the following statement is correct () </p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.5 Regarding the characteristics of the channel, the following statement is correct () </p>
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.6 Regarding unbuffered and conflicting channels, the following statement is correct ()	 </p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.7 About the trigger of the anomaly, the following statement is correct ()</p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.8 Regarding the applicable type of the cap function, the following statement is correct ()</p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.9 Reference answer [intermediate] on map, the following statement is correct () </p>
        <div class="options py-3"> 
