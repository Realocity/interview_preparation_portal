...
<div class="wrapper bg-white rounded">
    ...
    <div class="content"> 
        ...
        <div class="options py-3">
         ...
         <label class="rounded p-2 option"> Declaration </stylesheet> <input type="radio" name="radio"> <span class="checkmark"></span> </label> 
    ...
    <div class="content"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.7 __________ implementation that introduced text, list, box, margin, border, color, and background properties.</p>
        <div class="options py-3">
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> scatter()<input type="radio" name="radio"> <span class="checkmark"></span> </label> 
