...
types? </p>
     ...
     <div class="content"> 
        ...
        <div class="options py-3">
         <label class="rounded p-2 option">Val formatted= “%s %i”.format (mystring.myInt) <input type="radio" name="radio"> <span class="checkmark"></span> </label> 
        <label class="rounded p-2 option"> Val formatted= “%s %i”.formatted (mystring.myInt) <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> Val formatted= “%s %i”.formatstring(mystring.myInt) <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> Val formatted= “%s %i”.formatstrings(mystring.myInt)<input type="radio" name="radio"> <span class="crossmark"></span> </label> </div> 
    </div> 
     <div class="content"> 
