...
<div class="wrapper bg-white rounded">
    ...
    <div class="content"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.9 A âforâ loop will run faster in VB.NET or C# ?</p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.10 Whatâs the difference between a class field property ?</p>
        <div class="options py-3"> 
    ...
    <div id='pagination'>
     <div><span class="page current">7</span>
				...
				<a class='page next' href='visualBasicmcq8.jsp' title='Next'>&raquo;</a>
				</div>
				</div>
				<center>
</div>
