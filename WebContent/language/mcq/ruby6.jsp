...
<div class="wrapper bg-white rounded">
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.3 if looping through “f” object, how do you make a text field “name”? </p>
        <div class="options py-3">
         <label class="rounded p-2 option"> &lt;%= yield %><input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> … have the same URL<input type="radio" name="radio"> <span class="crossmark"></span> </label> 
