...
> x/y
     ...
     <div class="content"> 
        ...
        <div class="options py-3">
         <label class="rounded p-2 option">class(as.Date(“1970-01-02”)) <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> unclass(as.Date(“1970-01-02”)) <input type="radio" name="radio"> <span class="checkmark"></span> </label> 
        <label class="rounded p-2 option">unclassint(as.Date(“1970-01-02”)) <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> classint(as.Date(“1970-02-02”))<input type="radio" name="radio"> <span class="crossmark"></span> </label> </div> 
    </div> 
     <div class="content"> 
