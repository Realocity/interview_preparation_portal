...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.1  PHP files have a default file extension of .............</p>
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.2  Which of the following is/are a PHP code editor? </p>
        <div class="options py-3">
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.3 How to define a function in PHP?
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.4  what is the latest version of PHP? </p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.5  Which version of php introduced try/catch exception? </p>
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.6 Which PHP function is used to find files?
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.7 Is php is a programming language?</p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.8  PHP is a popular choice for coding blank programs. </p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.9 Which of the following variables is not a predefined variable in PHP?
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.10 Which of the following function is used to compress a string?</p>
        <div class="options py-3"> 
    ...
    <div id='pagination'>
     <div><span class="page current">9</span>
				...
				<a class='page next' href='php10.jsp' title='Next'>&raquo;</a>
				</div>
				</div>
				<center>
</div>
