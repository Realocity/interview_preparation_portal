...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.1 What is the meaning of “&gt;-“?</p>
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.2 In the expression x <- 4 in R, what is the class of ‘x’ as determined by the `class()’ function?</p>
        <div class="options py-3">
    ...
    <div class="content"> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> raw” objects are commonly used directly in data analysis <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option">“raw” objects are commonly used directly in data analysis <input type="radio" name="radio"> <span class="crossmark"></span> </label> </div> 
    </div> 
     <div class="content"> 
