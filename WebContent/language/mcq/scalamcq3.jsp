...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.21 It is not required to pass these __________ parameters to a method while calling it.</p>
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.22 What is Scalaâs programming paradigm?</p>
        <div class="options py-3">
    ...
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.23 Left and Right are case classes.</p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.24 Java compatibility makes Scala suitable for ________. </p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.25 Select the Scala construct that holds pairwise different elements of the same type. </p>
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.26 Scala is designed by ______. </p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.27 _______ is a Scala compiler that compiles to JavaScript.</p>
        <div class="options py-3">
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.28 Which one of the following is not a method defined by java.lang.String class?</p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.29 ________ abstraction from functional programming helps us deal with updating complex immutable nested objects.</p>
        <div class="options py-3"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.30 Which among the following is a Scala Web Frameworks?</p>
        <div class="options py-3"> 
