...
<section class="cards-wrapper-four">
  <div class="card-four-grid-space">
    ...
    <a class="card-four" href="https://telegra.ph/CSS---Coding-Questions-09-15" style="--bg-img: url(https://images1-focus-opensocial.googleusercontent.com/gadgets/proxy?container=focus&resize_w=1500&url=https://codetheweb.blog/assets/img/posts/html-syntax/cover.jpg)">
      <div>
        <h1>CSS Syntax</h1>
  ...
  <div class="card-four-grid-space">
    ...
    <a class="card-four" href="theory/cssTheory1.jsp" style="--bg-img: url('https://images1-focus-opensocial.googleusercontent.com/gadgets/proxy?container=focus&resize_w=1500&url=https://codetheweb.blog/assets/img/posts/links-images-about-file-paths/cover.jpg')">
      <div>
  ...
  <div class="card-four-grid-space">
    ...
    <a class="card-four" href="test/cssTest.jsp" style="--bg-img: url(https://images1-focus-opensocial.googleusercontent.com/gadgets/proxy?container=focus&resize_w=1500&url=https://codetheweb.blog/assets/img/posts/html-syntax/cover.jpg)">
      <div>
        <h1>CSS Syntax</h1>
        <p>The syntax of a language is how it works. How to actually write it. Learn CSS syntax…</p>
