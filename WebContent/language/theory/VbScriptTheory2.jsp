        ...
        <div class="card-group-control card-group-control-right">
            <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Mention if QTP generates VBScript code as we record actions, can't it possible to directly write using VBScript code when QTP does the same thing too? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question1" class="collapse show" style="">
                    <div class="card-body">No. it is not possible. QTP is the engine that runs through it. The VBScript relies on the QTP UI to perform the actions, such as clicking on a link on a web page.  </div>
                </div>
            </div>
                 <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <a class="text-muted text-uppercase" data-toggle="collapse" href="#question2">
                     <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Write a code to print numbers from 5 to 0? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question2" class="collapse show" style="">
                    <div class="card-body"> For i=5 To 0 step -1
WScript.Echo i
Next
                     </div>
                </div>
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Mention what is the main difference between function and sub-procedure? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question3" class="collapse show" style="">
                    <div class="card-body"> The main difference between function and sub-procedure is that function returns a value whereas a Sub-procedure does not. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> In what way program "hello world" you can write in VBScript? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question4" class="collapse show" style="">
                    <div class="card-body"> In VBScript, you can write hello world in two ways, the program will display a message box with text hello world.
...
Echo "Hello World"
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Explain about scrrun.dll in VBScript? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question5" class="collapse show" style="">
                    <div class="card-body">Scrrun.dll is used very much in programming VB. The scripting Runtime library is very important for the functioning of the Visual basic script. It provides much more functionality such as text operations, file management, and file modification features  </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What is VBScript language used for and which earlier language is it modeled upon? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question6" class="collapse show" style="">
                    <div class="card-body"> VBScript is a lightweight primary scripting language which is used for automation of the Scripts in QTP (Quick Test Professional) tool. This is modeled upon Visual Basic language. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What are the environments supported by VBScript language?	 <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
	...
	IE (Internet Explorer) â This is the most frequently used environment to run scripts and this is the simple hosting environment.
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What is the extension of the VBScript file? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question9" class="collapse show" style="">
                    <div class="card-body"> VBScript file is saved with an extension of .vbs. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Which respective symbols are used to separate a line and to break the lengthy statement into multiple statements in the VBScript language? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question11" class="collapse show" style="">
                    <div class="card-body"> Colons (:) act as a line separator and Underscore (_) is used to break the lengthy statement into multiple statements in the VBScript language. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What are the keywords in the VBScript language? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question12" class="collapse show" style="">
                    <div class="card-body"> There are some words that work as Reserved Words and they cannot be used as Variables names, Constant names or any other Identifier names, these are known as keywords. Some of the keywords in the VBScript language are Not, Nothing, Preserve, Optional, etc. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What are the naming conventions while declaring a variable in the VBScript language? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question14" class="collapse show" style="">
                    <div class="card-body"> Following are the rules for declaring a Variable name:
	...
	It should never contain a period (.).
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Which keyword is used to declare a variable in the VBScript language? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question15" class="collapse show" style="">
                    <div class="card-body"> The Dim keyword is used to declare a variable in the VBScript language. However, depending upon the scope of the variable, public or private keywords can also be used. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What are the 2 ways in which a variable can be declared in the VBScript language? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
	...
	Explicit Declaration: Declaring the variables before using them is known as the Explicit Declaration of variables.
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What is the use of Option Explicit Statement? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
...
If the user tries to use the variables which are not declared in case of Option Explicit then an error occurs. It is always recommended to use âOption Explicitâ at the top of the code so that even if you use the wrong name of the variable unintentionally, you can then correct it immediately without any confusion.
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Explain the scope of the variables using Dim, Public, and Private keywords respectively. <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question20" class="collapse show" style="">
                    <div class="card-body"> If the variable is declared using Dim keyword inside the function then its scope will be limited to the function level only i.e. this variable cannot be accessed once the function ends.
