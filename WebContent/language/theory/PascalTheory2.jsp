...
File-name = file of base-type;
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question20" class="collapse show" style="">
                    <div class="card-body"> Pascal uses extensions to extend the features uses in language but a program that is coded with the language doesn’t use many extensions because of fewer requirements of high performances. </div>
                </div>
            </div>
