        ...
        <div class="card-group-control card-group-control-right">
            <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What Is Rust Programming?	 <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question1" class="collapse show" style="">
                    <div class="card-body"> Rust is a very new language. Rust is a systems programming language focused on safety, speed and concurrency. </div>
                </div>
            </div>
                 <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <a class="text-muted text-uppercase" data-toggle="collapse" href="#question2">
                     <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> How Fast Is Rust? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question2" class="collapse show" style="">
                    <div class="card-body"> It is very fast, Rust is already competitive with idiomatic C and C++.	 </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Is Rust Object Oriented?		 <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question5" class="collapse show" style="">
                    <div class="card-body"> It is multi paradigm and most of the things can do in Rust but not everything. So, Rust is not object-oriented. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
...
Rust currently has limited support for compile time constants and we can define primitives using const declarations.
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question17" class="collapse show" style="">
                    <div class="card-body"> The glium is a library for OpenGL programming in Rust and GLFW is also a solid option. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
...
IUP and so on
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> How Do I Cross-compile In Rust? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question19" class="collapse show" style="">
                    <div class="card-body"> It is possible but need a bit of work to set up. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
