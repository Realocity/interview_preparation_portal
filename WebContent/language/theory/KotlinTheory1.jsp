 ...
 web assembly (wasm32) </div>
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question17" class="collapse show" style="">
                    <div class="card-body"> Kotlin supports the âdelegationâ design pattern by introducing a new keyword âbyâ. Using the 
...
access or modify a property using the dot(.) notation </div>
    ...
    <div id='pagination'>
     <div><span class="page current">1</span>
				...
				<a class='page next' href='KotlinTheory2.jsp' title='Next'>&raquo;</a>
				</div>
				</div>
