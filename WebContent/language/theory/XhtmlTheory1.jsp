        ...
        <div class="card-group-control card-group-control-right">
            <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What Is Xhtml? Why Xhtml? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question1" class="collapse show" style="">
                    <div class="card-body"> XHTML stands for Extensible Hypertext Markup Language. It is a combination of XML and HTML capabilities. XHTML can be viewed as intersection of HTML and XML in many aspects. </div>
                </div>
            </div>
                 <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <a class="text-muted text-uppercase" data-toggle="collapse" href="#question2">
                     <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Why To Use Xhtml? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question2" class="collapse show" style="">
                    <div class="card-body"> Most of the web pages contain bad HTML Combines the strengths of both XML and HTML.
...
Every XHTML document must have one root element.
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i>Differences Between Xml And Html	  <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
...
4. Comments start with &lt;â and end with â>. Inside a comment, "â" may not appear. Although this is fine in html, it confuses xml parsers.
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> How Is Xhtml Better Than Html? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question4" class="collapse show" style="">
                    <div class="card-body">The following are the reasons for why XTML is better than HTML:
...
Portable â Non-pc platforms can be accessed with XHTML.
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What Is Xhtml Modularization? Why Xhtml Modularization? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
...
Modularization of XTML acts as a means for the designers of product for specifying the elements that supports a specific devise by using standard building blocks and standard methods for building blocks usage. The content community gets âpoints of conformanceâ by using these modules
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i>How Is Xhtml Better Than Html? Why Would You Want To Use Xhtml?  <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question7" class="collapse show" style="">
                    <div class="card-body"> to be able to take advantage of new coding techniques
...
Currently, the Netscape browser helps greatly for testing web pages by displaying blank or broken pages when it comes across sloppy coding. IE is the most forgiving browser and will show almost any page no matter the extent of coding errors. While HTML itself isn't completely lacking in extensibility or portability but the evolution of it has been extremely slow compared to the pace of Internet development. This fuels the problems encountered trying to make your pages work on a wide range of browsers and platforms. XHTML will help to remedy those problems.
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> In Xhtml Tags May Overlap Or Not? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question8" class="collapse show" style="">
                    <div class="card-body"> In XHTML tags may not be overlapped.
Example: &lt;em> emphasized text and &lt;b>bold &lt;/em>text&lt;/b> We can use above example in XHTML like that, &lt;em>emphasized text &lt;/em> is &lt;b>bold text&lt;/b>
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Why Is This Xslt Important? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question9" class="collapse show" style="">
                    <div class="card-body"> Rather than manually creating WML markup, XSLT will enable XHTML documents to be automatically converted to WML. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Should I Use An Http Get Or Post For My Ajax Calls? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question10" class="collapse show" style="">
                    <div class="card-body"> AJAX requests should use an HTTP GET request when retrieving data where the data will not change for a given request URL. An HTTP POST should be used when state is updated on the server. This is in line with HTTP idempotency recommendations and is highly recommended for a consistent web application architecture.	 </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What Are The Advantages Of Xhtml? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question11" class="collapse show" style="">
                    <div class="card-body"> Some main advantage of XHTML are given below:
...
3.When your document is not well formed than it will immediately informed to you due to an error from your UA in XHTML.
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What The Benefits Of Xhtml Are? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question12" class="collapse show" style="">
                    <div class="card-body"> As XHTML is an XML application, you will benefit from developments in the XML world. For example XML tools such as editors, converters, browsers, etc. can be used with XHTML resources. In addition there are developments to the XML family of protocols and formats which will provide additional functionality for XHTML. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
...
The solution is to fix the HTML syntax errors. All content within a table must be within a TD or TH element.
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Do I Have To Memorize A Bunch Of Tags? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question14" class="collapse show" style="">
                    <div class="card-body"> No. Most programs that help you write HTML code already know most tags, and create them when you press a button. But you should understand what a tag is, and how it works. That way you can correct errors in your page more easily.	 </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Can I Have Two Or More Actions In The Same Form? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question15" class="collapse show" style="">
                    <div class="card-body"> No. A form must have exactly one action. However, the server-side (e.g., CGI) program that processes your form submissions can perform any number of tasks (e.g., updating a database, sending email, logging a transaction) in response to a single form submission. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> How Can I Use Forms For Pull-down Navigation Menus? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question16" class="collapse show" style="">
                    <div class="card-body"> There is no way to do this in HTML only; something else must process the form. JavaScript processing will work only for readers with JavaScript-enabled browsers. CGI and other server-side processing is reliable for human readers, but search engines have problems following any form-based navigation. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> How Can I Check For Errors? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question17" class="collapse show" style="">
                    <div class="card-body"> HTML validators check HTML documents against a formal definition of HTML syntax and then output a list of errors. Validation is important to give the best chance of correctness on unknown browsers (both existing browsers that you haven't seen and future browsers that haven't been written yet).
...
Link checkers follow all the links on a site and report which ones are no longer functioning. CSS checkers report problems with CSS style sheets
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What Is A Doctype? Which One Do I Use? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question18" class="collapse show" style="">
                    <div class="card-body"> According to HTML standards, each HTML document begins with a DOCTYPE declaration that specifies which version of HTML the document uses. Originally, the DOCTYPE declaration was used only by SGML-based tools like HTML validators, which needed to determine which version of HTML a document used (or claimed to use). Today, many browsers use the document's DOCTYPE declaration to determine whether to use a stricter, more standards-oriented layout mode, or to use a "quirks" layout mode that attempts to emulate older, buggy browsers. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What Is Everyone Using To Write Html? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question19" class="collapse show" style="">
                    <div class="card-body"> Everyone has a different preference for which tool works best for them. Keep in mind that typically the less HTML the tool requires you to know, the worse the output of the HTML. In other words, you can always do it better by hand if you take the time to learn a little HTML. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
