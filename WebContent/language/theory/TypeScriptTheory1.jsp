...
let values: Array<number> = [15, 20, 25, 30];
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question3" class="collapse show" style="">
                    <div class="card-body"> There are times when you want to store a value in a variable but don’t know the type of that variable in advance. For example, the value is coming from an API call or the user input. The ‘any’ type allows you to assign a value of any type to the variable of type any.
let person: any = "Foo";
                     </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                ...
                <div id="question4" class="collapse show" style="">
                    <div class="card-body"> The void indicates the absence of type on a variable. It acts as the opposite type to any. It is especially useful in functions that don’t return a value.
  ...
  y: 20
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question9" class="collapse show" style="">
                    <div class="card-body"> An object type can have zero or more optional properties by adding a ‘?’ after the property name. 
...
In the example above, because the property ‘z’ is marked as optional, the compiler won’t complain if we don’t provide it during the initialization.
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question10" class="collapse show" style="">
                    <div class="card-body"> In programming, a null value indicates an absence of value. A null variable doesn’t point to any object. Hence you cannot access any properties on the variable or call a method on it.
...
greet(foo);  // "Good morning, ANDERS"
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question11" class="collapse show" style="">
                    <div class="card-body"> When a variable is declared without initialization, it’s assigned the undefined value. It’s not very useful on its own. A variable is undefined if it’s declared, but no value has been assigned to it. In contrast, null is assigned to a variable, and it represents no value.  </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
...
console.log(typeof bar);  // "undefined"
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question15" class="collapse show" style="">
                    <div class="card-body"> A rest parameter allows a function to accept an indefinite number of arguments as an array. It is denoted by the ‘…’ syntax and indicates that the function can accept one or more arguments.
...
return sum;
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question19" class="collapse show" style="">
                    <div class="card-body"> A function can mark one or more of its parameters as optional by suffixing its name with ‘?’. In the example below, the parameter greeting is marked optional.
