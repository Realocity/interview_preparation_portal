	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">HTML-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         ...
	         {
	            text: "The tags which are required for every HTML page you create?",
	            responses: [
	         ...
	         {
	            text: "HTML tags are enclosed in-",
	            responses: [
	               { text: "# and # " },
	               {
	                  text: "{ and }"
	         ...
	         {
	            text: "What are the types of unordered or bulleted list in HTML? ",
	            responses: [
	               { text: "disc, square, triangle" },
	               { text: "polygon, triangle, circle " },
	               {
	         ...
	         {
	            text: "Which of the following HTML attribute is used to define inline styles? ",
	            responses: [
	         ...
	         {
		            text: "\The\  \ tags\  in \ HTML\  are _________?",
		            responses: [
		               { text: "case-sensitive" },
