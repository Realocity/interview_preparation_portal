...
var quiz = {
	      ...
	      questions: [
	         {
	            text: "SOAP stands for __________?",
	            responses: [
	               { text: "Simple Object Access Program" },
	               { text: "Simple Object Access Protocol", correct: true },
	               { text: "Simple Object Application Protocol" },
	               { text: "Simple Object Account Protocol" }
	            ]
	         },
	         {
	            text: "The ____ language allows more than one method in a single class?",
	            responses: [
	               { text: "C#", correct: true },
	               { text: "J#" },
	               { text: "C++" },
	         ...
	         {
	            text: "In C# a subroutine is called a ________?",
	            responses: [
	               { text: "Function" },
	               { text: "Metadata" },
	         ...
	         {
	            text: "All C# applications begin execution by calling the _____ method?",
	            responses: [
	               { text: "Class()" },
	         ...
	         {
	            text: "A _______ is an identifier that denotes a storage location?",
	            responses: [
	               { text: "Constant " },
	               {
	                  text: "Reference type"
	         ...
	         {
	            text: "The character pair ? is a________________available in C#? ",
	            responses: [
	               { text: " Unary operator" },
	               { text: "Ternary operator " , correct: true},
	               {
	                  text: "Decision operator"
	               },
	               { text: "Functional operator" }
	            ]
	         },
	         {
	            text: " In C#  all binary operators are ______? ",
	            responses: [
	               { text: "Center-associative" },
	               { text: "Right-associative" },
	               { text: "Left-associative ", correct: true },
	         ...
	         {
	            text: "\ The formal\  \ parameter-list \ is \ always\  enclosed in _______?",
	            responses: [
	               { text: "Square " },
	               { text: "Semicolon" },
