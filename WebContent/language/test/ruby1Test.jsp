	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">RUBY-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         {
	            text: "where do you edit routs?",
	            responses: [
	               { text: "controller" },
	               { text: "underscores" },
	               { text: "ActiveRecord" },
	               { text: "config/routes.rb", correct: true }
	            ]
	         },
	         {
	            ...
	            responses: [
	               { text: "underscores" },
	               { text: "it runs its validators" , correct: true},
	               { text: "validate" },
	         ...
	         },
	         {
	            ...
	            responses: [
	               { text: "rails generate scaffold User name:string email:string" },
	               { text: "self-contained bundles of gems. Useful for versioning." },
	               { text: "Edit Gemfile, then run 'bundle install' or just 'bundle'.", correct: true  },
	               { text: "Ruby Version Manager. Install and manage multiple versions of Ruby." }
	            ]
	         },
	         {
	            text: "What is gemset?",
	            responses: [
	               { text: " self-contained bundles of gems. Useful for versioning.", correct: true },
	               { text: "self-contained packages of Ruby code" },
	               {
	                  text: "Ruby Version Manager. Install and manage multiple versions of Ruby."
	               },
	               { text: "rails generate scaffold User name:string email:string" }
	         ...
	         },
	         {
	            ...
	            responses: [
	               { text: "rails generate scaffold User name:string email:string " },
	               {
	                  text: "self-contained packages of Ruby code", correct: true
	               },
	               { text: "self-contained bundles of gems. Useful for versioning."},
	               { text: "Ruby Version Manager. Install and manage multiple versions of Ruby." }
	            ]
	         },
	         {
	            ...
	            responses: [
	               { text: " rails generate scaffold User name:string email:string", correct: true },
	               { text: "Ruby Version Manager. Install and manage multiple versions of Ruby." },
	               { text: "self-contained packages of Ruby code" },
	               { text: "self-contained bundles of gems. Useful for versioning." }
	            ]
	         },
	         {
	            ...
	            responses: [
	               { text: " rails generate scaffold User name:string email:string" },
	               { text: " Ruby Version Manager. Install and manage multiple versions of Ruby. ", correct: true },
	               {
	                  text: "self-contained bundles of gems. Useful for versioning."
	               },
	               { text: "self-contained packages of Ruby code" }
	         ...
	         {
	            text: "how do you run a migration? ",
	            responses: [
	               { text: "CamelCase" },
	               { text: "ruby make" },
	               { text: "an object " },
	               { text: " rake db:migrate", correct: true }
	            ]
	         },
	         {
	            text:
	            ...
	            responses: [
	               ...
	               { text: "a responder object " },
	               { text: "validate" },
	               { text: " validates_numericality_of", correct: true }
	            ]
	         },
	         {
	            text: "\ Where\ \ do you\  add \ the filter \ code?",
	            responses: [
	               { text: "rails generate migration AddPhoneToTickets phone:string " },
	               { text: "the data being presented by the web page" },
	               { text: "data from model objects AND the page template" },
	               { text: " right after the line introducing the class in the controller", correct: true }
	            ]
	         }
	      ]
	   },
