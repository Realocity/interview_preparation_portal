	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">SWIFT-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         {
	            text: "Swift is which type of language?",
	            responses: [
	               { text: "scripting language" },
	               { text: "object oriented programming language" },
	               { text: "type safe language" },
	               { text: "All of the above", correct: true }
	            ]
	         },
	         {
	            text: "The IDE used in swift is____?",
	            responses: [
	               { text: "swiftc" },
	               { text: "gas" },
	         ...
	         {
	            text: "To create mutable object __ is used",
	            responses: [
	         ...
	         {
	            text: "To create contants in swift we use keyword ...?",
	            responses: [
	         ...
	         {
	            text: "Double has a precision of at least _ decimal digits in swift?",
	            responses: [
	         ...
	         {
	            text: "Which of the following is incorrect data type in SWIFT ? ",
	            responses: [
	               { text: "UInt "},
	               { text: " Double" },
	               {
	         ...
	         },
	         {
	            text: "What is a LLVM ? ",
	            responses: [
	               { text: "swiftc compiler" },
	               { text: "objective c compiler" },
	               { text: " contains both compiler (swiftc and objective c)" , correct: true },
	         ...
	         {
	            text: "\ For\ \ unwrapping value \  inside optional  \ what should \  we use?",
	            responses: [
	               { text: "? " },
	               { text: "@" },
	               { text: "!" , correct: true},
