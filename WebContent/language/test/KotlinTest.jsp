	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">KOTLIN-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         ...
	         {
	            text: "What is the default behavior of Kotlin classes?",
	            responses: [
	               { text: "All classes are sealed" },
	               { text: "All classes are public" },
	               { text: "All classes are abstract" },
	               { text: "All classes are final" , correct: true }
	            ]
	         },
	         {
	            text: "Which of the following is true for Kotlin variables?",
	            responses: [
	               { text: "var can't be changed" },
	               { text: "val corresponds to final variable in Java", correct: true },
	               { text: "val can be changed" },
	               { text: "All variables are immutable by default" }
	            ]
	         },
	         {
	            text: "What is an immutable variable?",
	            responses: [
	               { text: "A variable that can't change, read-only", correct: true },
	               { text: "A variable that can be changed" },
	               {
	                  text: "A variable used for string interpolation"
	               },
	               { text: "None of the above" }
	            ]
	         },
	         {
	            text: "Identify the correct way to create an arraylist in Kotlin?",
	            responses: [
	               { text: "val list = arrayListOf(1, 2, 3) ", correct: true  },
	               {
	                  text: "val map = hashMapOf(1 to one, 2 to two, 3 to three)"
	               },
	               { text: "val set = hashSetOf(1, 2, 3)" },
	               { text: "enum class Color {RED, GREEN, BLUE}" }
	            ]
	         },
	         {
	            text:
	         ...
	         {
	            text: "Which of the following open source license is Kotlin released under? ",
	            responses: [
	               { text: " FreeBSD License (BSD-2-Clause)" },
	               { text: "MIT License (MIT) " },
	               {
	                  text: "Apache License 2.0 (Apache 2.0)", correct: true
	               },
	         ...
	         {
	            text:
	               "Which file extension is used to save Kotlinfiles.",
	            responses: [
	               {
	                  text: ".kot"
	               },
	               { text: ".java " },
	               { text: ".andriod" },
	               { text: ".kt or .kts", correct: true }
	            ]
	         },
	         {
	            text: "\Kotlin was \ \developed under \ the \which\ license?",
	            responses: [
	               { text: "Apache 1.0 " },
	               { text: "Apache 1.1" },
	               { text: "Apache 2.0" , correct: true},
	               { text: "None of the above" }
	            ]
	         }
	      ]
