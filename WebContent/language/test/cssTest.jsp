	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">CSS-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         ...
	         {
	            text: "Which of the following property is used as the shorthand property for the padding properties? ",
	            responses: [
	               { text: "padding-left"},
	               { text: "padding-right " },
	               {
	         ...
	         {
	            text: "The CSS property used to make the text bold is -? ",
	            responses: [
	         ...
	         {
	            text: "\The CSS \ \property used to \ specify \the transparency \ of an element is -?",
	            responses: [
