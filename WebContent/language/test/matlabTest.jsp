	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">MATLAB-Quiz</h1>
					<!--progress-->
	      ...
	      questions: [
	         {
	            ...
	            responses: [
	               ...
	               { text: "Matrix Laboratory ", correct: true },
	               { text: "Mathworks" },
	               { text: "None of the above" }
	            ]
	         },
	         {
	            text: "What symbol precedes all comments in Matlab?",
	            responses: [
	               { text: "< " },
	               { text: "%" },
	               { text: "\\" },
	         ...
	         {
	            text: "Which of the following is not a pre-defined variable in Matlab?",
	            responses: [
	               { text: "pi" },
	               { text: "inf" },
	               { text: "i" },
	         ...
	         {
	            text: "This Matlab command clears all data and variables stored in memory?",
	            responses: [
	               { text: "clc" },
	         ...
	         {
	            text: "Characters in Matlab are represented in their value in memory?",
	            responses: [
	               { text: "decimal  " },
	               {
	         ...
	         {
	            text: "To better manage memory and prevent unnecessary memory allocations, Matlab uses? ",
	            responses: [
	               { text: " vectors" },
	               { text: "scalars " },
	               {
	               ...
	               { text: "delayed copy ", correct: true  }
	            ]
	         },
	         {
	            text: "To print a newline in afprintf statement, you must use the following escape character? ",
	            responses: [
	               { text: "\t " },
	               { text: "\nl" },
	               { text: "\nxt " },
	         ...
	         {
	            text: "\Which of the following \ \will correctly \ define \"x, y, and z \" as symbols?",
	            responses: [
	               { text: "sym (x, y, z)  " },
	               { text: "syms x y z ", correct: true },
	               { text: "syms x, y, z" },
	               { text: "None of the above" }
	            ]
	         }
