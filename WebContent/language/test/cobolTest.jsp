	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">COBOL-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         {
	            text: "COBOL stands is for.....?",
	            responses: [
	               { text: "Common Business Object Language" },
	               { text: "Common Beneficial Object Language" },
	               { text: "Common Business Oriented Language" , correct: true},
	               { text: "None of above" }
	            ]
	         },
	         {
	            text: "Which of the following is not a data type in COBOL?",
	            responses: [
	         ...
	         {
	            text: "The data division is used to ................. in COBOL?",
	            responses: [
	               { text: "File control" },
	               { text: "Declare variables", correct: true },
	               { text: "Declare program id" },
	               { text: "Input-Output section" }
	            ]
	         },
	         {
	            text: "We write logic of the program in ......................Division?",
	            responses: [
	               { text: "DATA DIVISION" },
	               ...
	               { text: "PROCEDURE DIVISION", correct: true }
	            ]
	         },
	         {
	            text: "Which of the following division is used to specify the computer used by the program?",
	            responses: [
	               { text: "Data Division " },
	               {
	                  text: "Procedure Division"
	               },
	               { text: "Environment Division", correct: true },
	               { text: "Identification Division" }
	            ]
	         },
	         {
	         ...
	         {
	            text: "What cobol is used for? ",
	            responses: [
	               { text: " Business" },
	               { text: "Finance " },
	               {
	                  text: "Administrative systems"
	               },
	               { text: "All of the above", correct: true }
	            ]
	         },
	         {
	            text: "Cobol and fortran came in which generation? ",
	            responses: [
	         ...
	         {
	            text: "\What is\ \the file\ extension \of\ cobol?",
	            responses: [
	               { text: ".cbl " },
	               { text: ".cob" },
	               { text: ".cpy" },
