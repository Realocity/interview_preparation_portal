	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">VB.NET-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         {
	            text: "Which of the following information is contained in the assembly manifest?",
	            responses: [
	               { text: "Files" },
	               { text: "Identity" },
	         ...
	         {
	            text: "Any project that compiles to an EXE or DLL files produces an assembly in .NET?",
	            responses: [
	         ...
	         {
	            text: "Which of the following is the best to retrieve Read-Only, Forward-only stream of data from database?",
	            responses: [
	               { text: "Data Set" },
	               { text: "Typed Data Set" },
	               { text: "DataReader" , correct: true},
	               { text: "None" }
	            ]
	         },
	         {
	            text: "The methods declared with the following modifiers are not accessible out side the current VB.NET project?",
	            responses: [
	               { text: "Public" },
	               { text: "Protected" },
	               {
	         ...
	         {
	            text: "How do you limit implicit type conversion in VB.NET?",
	            responses: [
	               { text: "Option Strict On ", correct: true },
	               {
	                  text: "Option Strict=1"
	               },
	         ...
	         },
	         {
	            ...
	            responses: [
	               { text: "A delegate is a strongly type function pointer" },
	               { text: "It is a type-safe function pointer" },
	               { text: "Delegates are used to create associations between events and event handlers in VB.NET" },
	               { text: "All of the above statements are correct for a delegate", correct: true }
	            ]
	         },
	         {
	            text: "Which of the following is not the member of System.Collections? ",
	            responses: [
	               { text: " BitArray" },
	         ...
	         {
	            text: "Which of the following control can contain other controls? ",
	            responses: [
	               { text: "GroupBox" },
	               { text: "TabPage" },
	               { text: "Panel " },
	         ...
	         {
	            text: "\The smallest unit to \ \ which one can \ associate \ a version number \  in .NET is?",
	            responses: [
	               { text: "CLR " },
