	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">PERL-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         {
	            text: "Which of the following data types are preceded by an at sign (@) in Perl?",
	            responses: [
	               { text: "Scalar" },
	         ...
	         {
	            text: "Which of the following data types are preceded by a percent sign (%) in Perl?",
	            responses: [
	               { text: "Scalar" },
	               { text: "Array" },
	               { text: "Hashes" , correct: true},
	               { text: "All of the above." }
	            ]
	         },
	         {
	            text: "Which of the following method shifts the first value of the array off and returns it, shortening the array by 1 and moving everything down?",
	            responses: [
	               { text: "push @ARRAY, LIST" },
	               { text: "pop @ARRAY" },
	               { text: "shift @ARRAY", correct: true },
	               { text: "unshift @ARRAY, LIST" }
	            ]
	         },
	         {
	            text: "How will you get the size of a Hash?",
	            responses: [
	               { text: "Using scalar context", correct: true },
	               { text: "usingsizeof operator" },
	               {
	         ...
	         {
	            text: "Which of the following statement jumps to the statement labeled with LABEL and resumes execution from there?",
	            responses: [
	               { text: "goto LABEL " , correct: true},
	               {
	                  text: "goto EXPR"
	               },
	               { text: "goto&NAME" },
	         ...
	         {
	            text: "Which of the following is correct about Array in Perl?",
	            responses: [
	               { text: " An array is a variable that stores an ordered list of scalar values" },
	               { text: " Array variables are preceded by an at (@) sign." },
	               {
	         ...
	         {
	            text: "Which of the following is true about state variables? ",
	            responses: [
	               { text: "state variables maintain their state and they do not get reinitialized upon multiple calls of the subroutines." },
	               { text: "These variables are defined using the state operator and available starting from Perl 5.9.4." },
	         ...
	         {
	            text:
	               "Which of the following function points current position of a pointer to a particular position in a file?",
	            responses: [
	               {
	                  text: "rename"
	               },
	               { text: "tell " },
	               { text: "seek", correct: true },
	               { text: " None of the above" }
	            ]
	         },
	         {
	            text: "\ Which of the \ \ following function \  returns \ all keys \  of a Hash?",
	            responses: [
