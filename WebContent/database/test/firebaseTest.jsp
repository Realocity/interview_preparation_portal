	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">FIREBASE-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         {
	            text: "Firebase is a backend platform for building?",
	            responses: [
	               { text: "Web" },
	               { text: "Android" },
	               { text: "IOS" },
	         ...
	         {
	            text: "The Firebase data is representing ________ objects?",
	            responses: [
	               { text: "SQL" },
	               { text: "Mongo" },
	         ...
	         {
	            text: "Founders of Firebase?",
	            responses: [
	               { text: "Google" },
	               { text: "James Tamplin", correct: true },
	               { text: "Donald D. Chamberlin" },
	               { text: "Raymond F. Boyce" }
	            ]
	         },
	         {
	            text: "Which method used to update the Firebase data?",
	            responses: [
	               { text: "alter" },
	               { text: "put" },
	               {
	         ...
	         {
	            text: "We can get any key from Firebase by using the ________ method?",
	            responses: [
	         ...
	         },
	         {
	            ...
	            responses: [
	               { text: "createEmailAndPassword()" },
	               { text: "createUser()" },
	               { text: "createUserWithEmailAndPassword()", correct: true },
	               { text: "createWithEmailAndPassword()" }
	            ]
	         },
	         {
	            text: "We can logout the user with the __________ method?",
	            responses: [
	               { text: " Exit()" },
	               { text: " signOut()", correct: true },
	               {
	                  text: "POP()"
	               },
	               { text: "POPOUT()" }
	         ...
	         {
	            text: "Which of the following is best practices for firebase? ",
	            responses: [
	               { text: "Avoid Nesting Data" },
	               { text: "Denormalize Data" },
	         ...
	         {
	            text: "\ Which\  \ of the \  following\ feature \ of Firebase?",
	            responses: [
	               { text: " Real-time" },
	               { text: "Hosting Authentication"},
	               { text: "Database" },
	               { text: "All of the above" , correct: true}
	            ]
	         }
