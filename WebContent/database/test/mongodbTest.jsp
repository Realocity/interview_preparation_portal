	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">MONGODB-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         {
	            text: "To install the latest stable version of MongoDB on SUSE, issue ______________?",
	            responses: [
	               { text: "sudozypper install mongodb-enterprise", correct: true },
	               { text: "sudozypper update mongodb-enterprise" },
	               { text: "sudozyp install mongodb-enterprise" },
	         ...
	         },
	         {
	            ...
	            responses: [
	               { text: "MongoDB can be installed on SUSE which is a Linux flavour" },
	               { text: "MongoDB Enterprise is available on select platforms and contains support for several features related to security and monitoring" },
	               { text: "A commercial edition of MongoDB that includes additional features" },
	               { text: "All of the mentioned" , correct: true}
	            ]
	         },
	         {
	            text: "The MongoDB instance stores its _________ files in /var/lib/mongo by default?",
	            responses: [
	               { text: "log" },
	         ...
	         {
	            text: "The MongoDB process listens on port _________ by default?",
	            responses: [
	         ...
	         },
	         {
	            ...
	            responses: [
	               { text: "If you change the user that runs the MongoDB process, you must modify the access control rights " },
	               {
	                  text: "The MongoDB instance stores its data files in /var/log/mongodb by default", correct: true
	               },
	               { text: "MongoDB uses memory mapped files for data management for efficiency" },
	               { text: "None of the mentioned" }
	            ]
	         },
	         {
	            ...
	            responses: [
	               { text: "mongodb.conf" },
	               { text: "mongod.conf" , correct: true},
	               { text: "mongodb.con" },
	               { text: "none of the mentioned" }
	            ]
	         },
	         {
	            text: "User account running mongod has _______ permissions for the directory? ",
	            responses: [
	               { text: " write only" },
	               { text: "read only" },
	               {
	                  text: "read and write", correct: true
	               },
	               { text: "none of the mentioned" }
	            ]
	         },
	         {
	            text: "MongoDB is installed unattended on Windows from the command line using ____________? ",
	            responses: [
	               { text: "msi.exe" },
	               { text: "msiexec.exe", correct: true },
	               { text: "exec.exe " },
	         ...
	         {
	            text: "\ Which of \ \ the following is a utility to \ check disk  \ I/O performance \ independently of MongoDB?",
	            responses: [
	               { text: "mongoperf " , correct: true},
	               { text: "mongoio" },
	               { text: "mongod" },
	               { text: "None of the above" }
	            ]
