	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">MARIADB-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         {
	            text: "MariaDB does not runs on a number of operating systems and do not supports a wide variety of programming languages?",
	            responses: [
	               { text: "True" },
	         ...
	         {
	            text: "What are the types of JOIN in MariaDB?",
	            responses: [
	               { text: "Inner Join" },
	               { text: "Outer Join" },
	               { text: "Left Join" },
	         ...
	         {
	            text: "What are the types of aggregate functions in MariaDB?",
	            responses: [
	               { text: "MariaDB COUNT Function" },
	               { text: "MariaDB SUM Function", correct: true },
	               { text: "MariaDB MIN Function" },
	               { text: "All of the above" , correct: true}
	            ]
	         },
	         {
	            text: "What are the different types of clauses used in MariaDB?",
	            responses: [
	               { text: "MariaDB Where Clause" },
	               { text: "MariaDB Like Clause" },
	               {
	                  text: "MariaDB Where Clause and MariaDB Like Clause", correct: true
	               },
	               { text: "None of the above" }
	            ]
	         },
	         {
	            text: "MariaDB does not support for PHP, one of the most popular web development languages?",
	            responses: [
	               { text: "True " },
	               {
	                  text: "False", correct: true
	         ...
	         },
	         {
	            ...
	            responses: [
	               { text: "connect()" },
	               { text: "mariadb_connect()" },
	               { text: "mysql_connect()", correct: true },
	               { text: "maria_connect()" }
	            ]
	         },
	         {
	            text: "Which of the following is not features of MariaDB? ",
	            responses: [
	               { text: " All of MariaDB is under GPL, LGPL, or BSD" },
	               { text: "MariaDB offers Galera cluster technology. " },
	               {
	                  text: "MariaDB uses a standard and popular querying language."
	               },
	               { text: "None of the above" , correct: true}
	            ]
	         },
	         {
	            text: "MariaDB Initial release? ",
	            responses: [
	               { text: "2008" },
	         ...
	         {
	            text: "\ Which\ \ command is used to \ Provides table  \ index information \ relating to the specified table?",
	            responses: [
	               { text: "SHOW INDEX FROM TABLENAME [table name] " , correct: true},
	               { text: "SHOW INDEX FROM TABLENAME" },
	               { text: "SHOW INDEX FROM [table name]" },
	               { text: "SHOW INDEX TABLENAME [table name]" }
	            ]
	         }
	      ]
	   },
