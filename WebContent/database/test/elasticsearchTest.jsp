	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">ELASTICSEARCH-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         {
	            text: "Elasticsearch Initial release?",
	            responses: [
	               { text: "2009" },
	         ...
	         {
	            text: "Programming language used in Elasticsearch?",
	            responses: [
	               { text: "C" },
	               { text: "C++" },
	         ...
	         {
	            text: "The Elasticsearch default communication port is?",
	            responses: [
	               { text: "9300/tcp", correct: true  },
	               { text: "3000/ip" },
	               { text: "9300/utp" },
	               { text: "3000/tcp" }
	            ]
	         ...
	         {
	            text: "Elasticsearch 7. x and later have a limit of ________ shards per node?",
	            responses: [
	               { text: "1" },
	               { text: "10" },
	               {
	         ...
	         {
	            text: "Which of the following collection of one or more nodes?",
	            responses: [
	               { text: "Node " },
	               {
	         ...
	         },
	         {
	            ...
	            responses: [
	               { text: "Elasticsearch is real time" },
	               { text: "Elasticsearch is distributed" },
	               { text: "Elasticsearch uses JSON objects as responses" },
	               { text: "All of the above", correct: true }
	            ]
	         },
	         {
	            text: " Which versioning is the default version that starts with 1 and increments with each update, deletes included?",
	            responses: [
	         ...
	         {
	            text: " In URI Search, which parameter denotes the number of hits to return?",
	            responses: [
	               { text: "from" },
	         ...
	         {
	            text: "\ The \  \ default \  Elasticsearch\ log \ level is?",
	            responses: [
	               { text: "Error " },
	               { text: "Trace" },
	               { text: "Warn" },
