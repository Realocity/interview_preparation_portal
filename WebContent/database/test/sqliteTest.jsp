	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">SQLITE-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         ...
	         {
	            text: "SQLite is an in-process library that implements a?",
	            responses: [
	               { text: "self-contained" },
	               { text: "serverless" },
	         ...
	         {
	            text: "Which command is used to modifies an existing database object, such as a table?",
	            responses: [
	               { text: "Create" },
	         ...
	         {
	            text: "Which command print STRING in place of NULL values?",
	            responses: [
	               { text: "null STRING " },
	               {
	                  text: "value STRING"
	               ...
	               { text: "nullSTRING" },
	               { text: "nullvalue STRING", correct: true  }
	            ]
	         },
	         {
	            text:
	         ...
	         {
	            text: "Which of the following command is true regarding ROLLBACK Statement? ",
	            responses: [
	               { text: " ROLLBACK;" },
	               { text: "ROLLBACK TO SAVEPOINT savepoint_name; " },
	               {
	         ...
	         {
	            text: "By using sqlite3 , we can store our data on? ",
	            responses: [
	         ...
	         },
	         {
	            ...
	            responses: [
	               {
	                  text: "To close the query"},
	               { text: "To close the table " },
	               { text: "To close the database", correct: true },
	               { text: "None of the above" }
	            ]
	         },
	         {
	            text: "\ What is the\  \ correct statement\ about the  \ RawQuery() function in\ sqlite3 in python?",
	            responses: [
	               { text: "It is used to fetch the row from the table " },
	               { text: "It is used to execute the select query in the table" },
	               { text: "It is undefined function in python sqlite3", correct: true },
	               { text: "1 and 2" }
	            ]
	         }
	      ]
