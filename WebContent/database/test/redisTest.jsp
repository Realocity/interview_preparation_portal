	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">REDIS-Quiz</h1>
					<!--progress-->
	      ...
	      questions: [
	         {
	            ...
	            responses: [
	               ...
	               { text: "End-user database" },
	               { text: "Commercial database" }
	            ]
	         },
	         {
	            text: "Redis Developer?",
	            responses: [
	               { text: "C. Redis" },
	               { text: "P. Redis" },
	               { text: "Redis Labs" , correct: true},
	               { text: "Z. Redis" }
	            ]
	         },
	         {
	            text: "Redis is very fast and can perform about ___________ SETs per second?",
	            responses: [
	               { text: "10000" },
	         ...
	         {
	            text: "To update configuration, you can edit redis.conf file directly or you can update configurations via?",
	            responses: [
	               { text: "CONFIG update command" },
	               { text: "CONFIG put command" },
	               {
	                  text: "CONFIG alter command"
	               },
	               { text: "CONFIG set command" , correct: true}
	            ]
	         },
	         {
	            text: "How many types of data types redis supports?",
	            responses: [
	               { text: "3" },
	               {
	                  text: "4"
	         ...
	         {
	            text: "Which of the following basic syntax of Redis client? ",
	            responses: [
	               { text: " $redis-client" },
	               { text: "$redis cli " },
	               {
	                  text: "$redis-cli", correct: true
	               },
	               { text: "$redis client" }
	            ]
	         },
	         {
	            text: "Which of the following command is used to Changes the key name? ",
	            responses: [
	               { text: "RENAME key newkey", correct: true},
	               { text: "RANDOMKEY" },
	               { text: "RENAMENX key newkey " },
	               { text: "TYPE key" }
	            ]
	         },
	         {
	            ...
	            responses: [
	               {
	                  text: "The command used to delete the command."
	               },
	               { text: "The command is used to delete the key. " , correct: true },
	               { text: "The command is used to set the keys." },
	               { text: "None of the above" }
	            ]
	         },
	         {
	            text: "\ Which\ \ of the \ following is a key  \ in string?\ SET name letsfindcourse ",
	            responses: [
