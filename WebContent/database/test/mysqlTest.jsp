	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">MYSQL-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         {
	            text: "The father Of MySQL Is ______?",
	            responses: [
	               { text: "Bill Joy" },
	               { text: "Michael Widenius", correct: true },
	               { text: "Bill Gates" },
	               { text: "Stephanie Wall" }
	            ]
	         },
	         {
	            text: "To Use MySQL On Your Computer, You'll Need",
	            responses: [
	               { text: "Perl, PHP Or Java" },
	               { text: "A Browser" },
	               { text: "Some Sort Of Client Program To Access The Databases" , correct: true},
	               { text: "FTP And Telnet" }
	            ]
	         },
	         {
	            text: "The Main MySQL Program That Does All The Data Handling Is Called?",
	            responses: [
	               { text: "Mysql" },
	               { text: "Mysql.exe" },
	               { text: "Httpd" },
	               { text: "Mysqld" , correct: true}
	            ]
	         },
	         {
	            text: "MySQL Comes With As Standard With Client Libraries For?",
	            responses: [
	         ...
	         {
	            text: "What Kind Of Replication Is Supported By The MySQL Server?",
	            responses: [
	               { text: "Multiple-master Replication " },
	               {
	                  text: "Single File Based Clustering"
	               },
	               { text: "Master To Slave Replication", correct: true },
	               { text: "MySQL Doesn't Support Replication" }
	            ]
	         },
	         {
	            text:
	            ...
	            responses: [
	               ...
	               { text: "The Structured Query Language", correct: true }
	            ]
	         },
	         {
	            text: "MySQL Runs On Which Operating Systems? ",
	            responses: [
	               { text: " Unix And Linux Only" },
	               { text: "Unix, Linux, Windows And Others " , correct: true},
	               {
	                  text: "Linux And Mac OS-X Only"
	               },
	               { text: "Any Operating System At All" }
	            ]
	         },
	         {
	            text: "Which of the following is not supported by MySQL? ",
	            responses: [
	               { text: "Temporary (Hash) Tables" },
	               { text: "Table Joining" },
	         ...
	         },
	         {
	            ...
	            responses: [
	               {
	                  text: "There Isn't A Program Just Called Mysql"
	               },
	               { text: "A Wrapper Through Which Java Clients Must Connect To The Databases " },
	               { text: "The Database Engine" },
	               { text: "A Client Program That Lets You Send SQL Commands To The Database Engine" , correct: true}
	            ]
	         },
	         {
	            text: "\ Which\  \ Of The\ Following \ Is NOT\ Available In MySQL?",
	            responses: [
	               { text: "REVOKE " },
