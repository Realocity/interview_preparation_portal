	...
	<div class="questionBox" id="app">
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
			...
			<div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
				...
				<header>
					<h1 class="title is-6">POSTGRESQL-Quiz</h1>
					<!--progress-->
...
var quiz = {
	      ...
	      questions: [
	         {
	            text: "PostgreSQL can be used from just about any major programming language, including C, C++, Perl, Python, Java, Tcl, and PHP?",
	            responses: [
	         ...
	         {
	            text: "When you want to use a join between columns that are in the same table, you use what type of join?",
	            responses: [
	               { text: "union" },
	               { text: "right outer" },
	               { text: "left outer" },
	         ...
	         {
	            text: " What do you call the application that makes requests of the PostgreSQL server?",
	            responses: [
	               { text: "Workstation" },
	         ...
	         {
	            text: "Which of the following best describes a role?",
	            responses: [
	               { text: "A server’s purpose within a cluster." },
	               { text: "The purpose of a particular database." },
	               {
	                  text: "A cluster’s purpose."
	               },
	               { text: "A template for authorization to various database objects." , correct: true}
	            ]
	         },
	         {
	            text: "The most common method to get data into a table is to use what command?",
	            responses: [
	         ...
	         },
	         {
	            ...
	            responses: [
	               ...
	               { text: "a hierarchical database management system. " },
	               {
	                  text: "a network-type database management system."
	               },
	               { text: "an XML database management system." }
	            ]
	         },
	         {
	            text: "We add data to PostgreSQL by using which statement? ",
	            responses: [
	               { text: "INSERT" , correct: true},
	               { text: "ADD" },
	               { text: "UPDATE " },
	         ...
	         {
	            text: "\ With\ \ PostgreSQL\ , you  \ can\ access data by?",
	            responses: [
	               { text: "Use function calls (APIs) to prepare and execute SQL statements, scan result sets and perform updates from a large variety of different programming languages. " },
	               { text: "Use a command-line application to execute SQL statements" },
	               { text: "All of these", correct: true  },
	               { text: "Embed SQL directly into your application" }
	            ]
	         }
	      ]
	   },
