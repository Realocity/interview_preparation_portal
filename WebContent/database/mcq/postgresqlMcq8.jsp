...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.1 When a table is created which uses a table name as a column type, not null constraints on the column type’s table definition is honored by the including table.</p>
    ...
    <div class="content"> 
        ...
        <div class="options py-3">
         <label class="rounded p-2 option"> A domain is created by ‘CREATE DOMAIN’.<input type="radio" name="radio"> <span class="crossmark"></span> </label>
    ...
    <div class="content"> 
     ...
     <div class="content"> 
        <p class="text-justify h5 pb-2 font-weight-bold">Q.10 To enable continuous archiving, all you have to do is set archive_mode to ‘on’ in postgresql.conf</p>
        <div class="options py-3"> 
        <label class="rounded p-2 option"> True <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> False <input type="radio" name="radio"> <span class="checkmark"></span> </label> 
        <label class="rounded p-2 option"> May be <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
