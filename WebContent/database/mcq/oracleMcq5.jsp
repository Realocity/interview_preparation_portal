...
<div class="wrapper bg-white rounded">
    <div class="content"> 
        ...
        <label class="rounded p-2 option"> FTP <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> A&C both<input type="radio" name="radio"> <span class="checkmark"></span> </label> </div>
    ...
    <div class="content"> 
        ...
        <div class="options py-3">
         ...
         <label class="rounded p-2 option"> retrieve data more quickly </stylesheet> <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
    ...
    <div class="content"> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option">  %COL<input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> none of these<input type="radio" name="radio"> <span class="crossmark"></span> </label> </div> 
    </div> 
     <div class="content"> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> database files <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> none of these<input type="radio" name="radio"> <span class="crossmark"></span> </label> </div> 
    </div> 
     <div class="content"> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> redolog file <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
    ...
    <div id='pagination'>
     <div>      
				...
				<a class='page next' href='oracleMcq6.jsp' title='Next'>&raquo;</a>
				</div>
				</div>
</div>
<br><br>
