...
<div class="wrapper bg-white rounded">
    ...
    <div class="content"> 
     ...
     <div class="content"> 
        ...
        <div class="options py-3"> 
        <label class="rounded p-2 option">  auditpol /set /subcategory:”application generated” /success:enable /failure:enable<input type="radio" name="radio"> <span class="checkmark"></span> </label> 
        <label class="rounded p-2 option">  polaudit /set /subcategory:”application generated” /success:enable /failure:enable<input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option"> auditpolenable /set /subcategory:”application generated” /success:enable /failure:enable <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option">  auditenable /set /subcategory:”application generated” /success:enable /failure:enable<input type="radio" name="radio"> <span class="crossmark"></span> </label> </div> 
    </div> 
