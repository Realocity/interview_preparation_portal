...
<div class="wrapper bg-white rounded">
    ...
    <div class="content"> 
        ...
        <div class="options py-3">
         ...
         <label class="rounded p-2 option"> Python </stylesheet> <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
         <label class="rounded p-2 option"> PHP <input type="radio" name="radio"> 
    ...
    <div class="content"> 
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> computer gateway interface<input type="radio" name="radio"> <span class="crossmark"></span> </label> 
...
Perl, PHP
     ...
     <div class="content"> 
        ...
        <label class="rounded p-2 option"> PHP, Perl, C <input type="radio" name="radio"> <span class="crossmark"></span> </label> 
        <label class="rounded p-2 option">  C, PHP, Perl<input type="radio" name="radio"> <span class="crossmark"></span> </label> </div> 
    </div> 
    ...
    <div id='pagination'>
     <div>
				...
				<a class='page next' href='mysqlMcq9.jsp' title='Next'>&raquo;</a>
				</div>
				</div>
</div>
<br><br>
