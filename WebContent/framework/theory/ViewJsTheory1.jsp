...
Light weight: VueJS is light weight library compared to other frameworks.
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question3" class="collapse show" style="">
                    <div class="card-body"> Lifecycle hooks are a window into how the library you’re using works behind-the-scenes. By using these hooks, you will know when your component is created, added to the DOM, updated, or destroyed.  </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
...
&lt;/template>
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question7" class="collapse show" style="">
                    <div class="card-body"> In order to track each node’s identity, and thus reuse and reorder existing elements, you need to provide a unique key attribute for each item with in v-for iteration. An ideal value for key would be the unique id of each item.
