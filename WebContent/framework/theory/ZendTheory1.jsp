        ...
        <div class="card-group-control card-group-control-right">
            <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What is a zend framework and why it is used? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question1" class="collapse show" style="">
                    <div class="card-body"> Zend framework is an advanced collection of professional PHP packages which can be used to develop web services and applications using PHP 5.6+. It offers 100% object-oriented code using a broad spectrum of features related to languages. It has more than 379 million installations </div>
                </div>
            </div>
                 <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <a class="text-muted text-uppercase" data-toggle="collapse" href="#question2">
                     <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Who developed the Zend Framework? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question2" class="collapse show" style="">
                    <div class="card-body"> Zend Framework is developed by Zend Technologies, a Cupertino, California, U.S based world full web infrastructure software company founded by Andi Gutmans and Zeev Suraski in 1999. The Zend framework was initially released on March 3, 2006. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What is the latest version of Zend Framework? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question3" class="collapse show" style="">
                    <div class="card-body"> Zend Framework 3 is the latest version of Zend Framework. It was released on 28 June 2016. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> List some advantages of Zend Framework as compared to other frameworks <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question4" class="collapse show" style="">
                    <div class="card-body"> 	Fully object-oriented framework and utilizes many object-oriented concepts such as interfaces and inheritance.
	...
	Compose and send email features.
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> How to install Zend on your local machine? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question5" class="collapse show" style="">
                    <div class="card-body"> 	Create a new SSH user
	...
	Run the following syntax to install the Zend framework
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> How to include css and js from the controller in the zend framework? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question6" class="collapse show" style="">
                    <div class="card-body"> 	Create AppController.php
	...
	Then, from the controller, append or prepend custom javascript code dynamically just before at bottom to finish
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> How we can check post method in zend framework? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
...
from end_Controller_Request_Abstract. So, IDE can’t offer this method, but it’s present there.
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> How to get all post data in zend framework? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question10" class="collapse show" style="">
                    <div class="card-body"> $this->getRequest()->getPost(); </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i>How to get all get data in zend framework?  <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question11" class="collapse show" style="">
                    <div class="card-body"> $this->getRequest()->getParams(); </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i>In which file we can configuration in zend framework?  <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question14" class="collapse show" style="">
                    <div class="card-body">We can set the config in an application.ini file which is located in application/configs/application.ini.  </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What is the purpose of autoloader in Zend Framework? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question16" class="collapse show" style="">
                    <div class="card-body"> The Zend_Loader_Autoloader or autoloader has introduced a comprehensive autoloading solution to the Zend framework. It provides an accurate namespace autoloader and allows registering arbitrary callbacks as autoloaders. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i>How to create an object of Model in Zend Framework?  <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question17" class="collapse show" style="">
                    <div class="card-body"> $pageObj = new Application_Model_Pages(); </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> How to create a Model file in zend framework? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question18" class="collapse show" style="">
                    <div class="card-body"> class Application_Model_Pages extends Zend_Db_Table_Abstract {
...
Zend framework consists of loosely connected components, which can be utilized easily in an application. It is used for the web application that utilizes a lot of functions and libraries without using much of coding. It is a pure object-oriented web application system, which is built up of advanced MVC design pattern.
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Which version of PHP does Zend Framework require? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question20" class="collapse show" style="">
                    <div class="card-body"> Zend Framework requires PHP 5.2.4 and up. Zend framework is enhanced to utilize all of the object-oriented features of PHP 5.2.4 and have the advantage of prominent security and performance enhancements. </div>
                </div>
            </div>
