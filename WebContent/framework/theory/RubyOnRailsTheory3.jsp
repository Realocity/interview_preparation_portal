        ...
        <div class="card-group-control card-group-control-right">
            <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Explain what is a class library in Ruby? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question1" class="collapse show" style="">
                    <div class="card-body"> Ruby class libraries consist of a variety of domains, such as thread programming, data types, various domains, etc. These classes give flexible capabilities at a high level of abstraction, giving you the ability to create powerful Ruby scripts useful in a variety of problem domains. The following domains which have relevant class libraries are,
	GUI programming
	Network programming
	CGI Programming
	Text processing
                ...
                <div class="card-header">
                    ...
                    <a class="text-muted text-uppercase" data-toggle="collapse" href="#question2">
                     <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> In Ruby, it explains about the defined operator? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question2" class="collapse show" style="">
                    <div class="card-body"> The defined operator tells whether a passed expression is defined or not.  If the expression is not defined, it gives null, and if the expression is defined it returns the description string. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Mention what is the difference in scope for these two variables: @@name and @name? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question3" class="collapse show" style="">
                    <div class="card-body"> The difference in scope for these two variables is that:
	...
	@name is an instance variable
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Mention what is the syntax for Ruby collect Iterator? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question4" class="collapse show" style="">
                    <div class="card-body"> The syntax for Ruby collect Iterator collection = collection.collect. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Explain what is Interpolation in Ruby? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question5" class="collapse show" style="">
                    <div class="card-body"> Ruby Interpolation is the process of inserting a string into a literal.  By placing a Hash (#) within {} open and close brackets, one can interpolate a string into the literal. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Mention what is the Notation used for denoting class variables in Ruby? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
	...
	A class variable should begin with double @@ and have to be first initialized before being used in a method definition
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Mention what is the difference between Procs and Blocks? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question7" class="collapse show" style="">
                    <div class="card-body"> The difference between Procs and Blocks,
	...
	Plugin: Plugin is also ruby code, but it is installed in the application folder and only available for that specific application.
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Is Ruby statically or dynamically typed? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question11" class="collapse show" style="">
                    <div class="card-body"> Ruby is dynamically typed. This is why you can change the type of a variable on the fly. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Tell me about getters and setters in Ruby <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question12" class="collapse show" style="">
                    <div class="card-body"> A getter allows accessing an instance variable. A setter allows setting an instance variable. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What is Gemfile.lock? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question15" class="collapse show" style="">
                    <div class="card-body"> It contains records of exact versions of gems installed. This is so the same versions can be installed if another machine clones the project. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
...
Digging into each one is the topic of a full post but here is a great tutorial with examples.
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What are initializers in Rails? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question17" class="collapse show" style="">
                    <div class="card-body"> Initializers hold configuration logic and only run when an app is booted. This means the Rails server needs to be restarted if initializers are changed. They exist in the /config/initializers directory. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What is the difference between delete and destroy? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question18" class="collapse show" style="">
                    <div class="card-body"> What is the difference between delete and destroy?
