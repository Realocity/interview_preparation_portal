...
No CSS support means that while HTML and JavaScript are modularized into components, CSS is conspicuously left out
                ...
                <div id="question2" class="collapse show" style="">
                    <div class="card-body"> Filters can be used to apply common text formatting. These Filters should be appended to the end of the JavaScript expression, denoted by the âpipeâ symbol. You can use them in two specific cases: </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
...
vnode: The virtual node produced by Vueâs compiler.
...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center">
    <li >
     <a class="page-link" href="VueJsTheory1.jsp">Previous</a>
    </li>
