            ...
            <div class="card mb-2 w-100">
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Can I Use A Database Other Than Mongodb With Meteor? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question4" class="collapse show" style="">
                    <div class="card-body"> Currently MongoDB is the only database that is officially supported with Meteor. We are listening closely to the frequent requests to support other kinds of databases. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Does Meteor Work On Windows? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question6" class="collapse show" style="">
                    <div class="card-body"> Yes, you can install Meteor on Windows. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> How Do I Get Started?<i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question7" class="collapse show" style="">
                    <div class="card-body">  Get started with Meteor by installing, then completing a tutorial using any of our supported UI frameworks: Blaze, Angular, or React.</div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> How Much Does It Cost To Use Meteor? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question8" class="collapse show" style="">
                    <div class="card-body"> Meteor is open source and free to use. If you would like support in developing your application, consider our developer subscription. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What Open Source License Does Meteor Use? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question9" class="collapse show" style="">
                    <div class="card-body">  Meteor is available under the MIT license.</div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i>  What Is Meteor?<i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question10" class="collapse show" style="">
                    <div class="card-body">  Meteor, or MeteorJS is an open-source real-time JavaScript framework written using Node.js. Meteor allows for rapid development and prototyping and produces cross-platform code. Giving your the cross platform flexibility making it possible to leverage one code base for desktop, iOS and Android applications.</div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i>  Why Should I Use Meteor?<i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question11" class="collapse show" style="">
                    <div class="card-body"> Because Meteor use one language on the front end and back it end, it dramatically speeds development time and is great for rapid prototyping. Saving you cost and time plus Meteor make apps feel like top-tier web properties like Facebook or Twitter, or like a great desktop applications.  </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Browser And Mobile? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question13" class="collapse show" style="">
                    <div class="card-body"> Yes you heard right, Meteor supports both web and mobile using Apache Cordova, Meteor can also connect to devices, existing applications and IoT. Providing robust options. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Are Developers Using Meteor? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question15" class="collapse show" style="">
                    <div class="card-body"> Definitely, Meteor has an amazing international community and over 6,635 open source Meteor packages. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Are Companies Using Meteor In Production? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question16" class="collapse show" style="">
                    <div class="card-body"> Yes there are some amazing web and mobile applications here are just a few
<br>o	Respondly
<br>o	Verso
<br>o	Workpop
<br>o	Classcraft
...
<br>o	Meteor Raises $20M To Build The One JavaScript Stack To Rule Them All, TechCrunch 
                     </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> Can Meteor Scale? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question18" class="collapse show" style="">
                    <div class="card-body"> This is always one of the first questions asked with any new technology, I remember when Ruby on Rails started to get traction everyone was saying this or when Node.JS first came out. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
...
<br>o	Meteor Security 201
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What Is Meteor Js? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                <div id="question20" class="collapse show" style="">
                    <div class="card-body"> o	Meteor or Meteor Js is an open-source platform for developing modern web, mobile (iOS, Android and Windows), and desktop apps with the help of using NodeJS platform. Meteor allows for rapid development and prototyping and produces cross-platform code.
<br>o	Meteor automatically manages the data flow between cloud and client applications, as well as client UI state and rendering, regardless of which UI framework you use.
<br>o	Meteor is a JavaScript platform used for developing web and mobile applications. Applications develop using Meteor framework supports different platforms (windows, android, and iOS). Meteor includes a key set of technologies such as Node.js and general JavaScript community.
<br>o	Meteor was developed by Meteor Development Group and maintained by same and it is integrated with Angular, MongoDB, npm and Cordova and many more.
                     </div>
                </div>
            </div>
