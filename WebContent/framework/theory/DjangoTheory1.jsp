        ...
        <div class="card-group-control card-group-control-right">
            <div class="card mb-2 w-100">
                ...
                <div id="question1" class="collapse show" style="">
                    <div class="card-body"> Django follows the MVT (Model View Template) pattern which is based on the Model View Controller architecture. It’s slightly different from the MVC pattern as it maintains its own conventions, so, the controller is handled by the framework itself. The template is a presentation layer. It is an HTML file mixed with Django Template Language (DTL). The developer provides the model, the view, and the template then maps it to a URL, and finally, Django serves it to the user. </div>
                </div>
            </div>
                 <div class="card mb-2 w-100">
                <div class="card-header">
	...
	Comments
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question5" class="collapse show" style="">
                    <div class="card-body"> A view function, or “view” for short, is simply a Python function that takes a web request and returns a web response. This response can be HTML contents of a web page, or a redirect, or a 404 error, or an XML document, or an image, etc.  </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question7" class="collapse show" style="">
                    <div class="card-body"> Websites generally need to serve additional files such as images. Javascript or CSS. In Django, these files are referred to as “static files”, Apart from that Django provides django.contrib.staticfiles to manage these static files. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
...
7	django-admin diffsettings - Shows the difference between the existing settings file and Django’s default settings.
...
For eg, payment system(app) in the eCommerce app(Project).
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question13" class="collapse show" style="">
                    <div class="card-body"> 	Abstract Base Class Inheritance: Used when you only need the parent class to hold information that you don’t want to write for each child model.
...
5.	The response also passes through the response middlewares and send back to the client/browser.
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question18" class="collapse show" style="">
                    <div class="card-body"> PostgreSQL and MySQL, SQLite and Oracle. Apart from these, Django also supports databases such as ODBC, Microsoft SQL Server, IBM DB2, SAP SQL Anywhere, and Firebird using third-party packages. Note: Officially Django doesn’t support any no-SQL databases. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                <div class="card-header">
                    ...
                    <i class="fa fa-question-circle-o mr-2 mt-0-20 pull-left"></i> What’s the use of Middleware in Django? <i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
