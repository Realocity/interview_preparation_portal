...
<title>Etherlime Theory 3</title>
</head>
<body>
 <!-- navbar -->
...
Ethereumâs global state consists of a mapping between account addresses and the account states. This mapping is stored in the Merkle Patricia tree. In this data structure, data is stored in the form of a key-value pair.  The state in Ethereum is different, and as explained by Vitalik Buterin, it is a key-value map. The keys are the addresses of an account, and the values are nonces, account balances, and code and storage. 
                     </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
...
For certain actions to enforce, be it transfer of fund or modification in the base code, there should be the consent of at least 2/3rd of the members. Methods for allocating a DAOâs funds could range from bounties, salaries, internal currency to reward work.
                     </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
...
<br>GHOST solves the issue of network security loss by including in the calculation of which chain is the âlongest by not only including the parent and further ancestors of a block but also the stale blocks (called uncle blocks).
                     </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                ...
                <div id="question6" class="collapse show" style="">
                    <div class="card-body"> nonce: For an externally owned account, this number represents the number of transactions sent from the accountâs address. For a contract account, the nonce is the number of contracts created by the account.
...
codeHash: The hash of the EVM code of this account. For contract accounts, this is the code that gets hashed and stored as the codeHash. For externally owned accounts, the codeHash field is the hash of the empty string.
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question7" class="collapse show" style="">
                    <div class="card-body"> The private key along with the transaction data is used to sign a transaction. ECDSA signatures in a transaction consist of three parameters r, s, and v. Ethereum clients provide a global method that returns an address given these three parameters. If the returned address is the same as the signerâs address, then the signature is valid. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
                ...
                <div id="question8" class="collapse show" style="">
                    <div class="card-body"> The âdifficultyâ of a block is used to enforce consistency in the time it takes to validate blocks. If a certain block is validated more quickly than the previous block, the Ethereum protocol increases that blockâs difficulty. If a block validation takes more time than the previous block, the Ethereum protocol decreases that blockâs difficulty. </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question11" class="collapse show" style="">
                    <div class="card-body"> Whisper is a peer-to-peer communication protocol for Dapps built upon the Ethereum network. It provides a privacy-focused, encrypted messaging system for Dapps. Properties of Whisper protocolâ
<br>1.	Low-level
<br>2.	Low-bandwidth
<br>3.	Uncertain-latency
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question12" class="collapse show" style="">
                    <div class="card-body">  Dapp stands for Decentralized Applications. They are like normal apps but the key difference is, that Dappsâ components run one or more peer-to-peer networks, such as a blockchain. It was popularized by Ethereum.</div>
                </div>
            </div>
              <div class="card mb-2 w-100">
                <div class="card-header">
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question16" class="collapse show" style="">
                    <div class="card-body"> 1.	Constructor â It is an optional function and is used to initialize state variables of a contract.
<br>2.	Payable functions â Payable functions provide a mechanism to collect/receive funds in ethers to your contract.
<br>3.	Fallback functions â Fallback functions are unnamed functions. They are executed when a function identifier does not match any of the available functions in a smart contract
<br>4.	View functions -View functions ensure that they will not modify the state.
<br>5.	Pure functions â Pure functions ensure that they are not read or modify the state.
                     </div>
                </div>
            </div>
              <div class="card mb-2 w-100">
...
<br>Archive Sync: It is similar to full sync but stores all intermediate states in the disk.
              ...
              <div class="card mb-2 w-100">
                ...
                <div id="question20" class="collapse show" style="">
                    <div class="card-body"> A nonce is an abbreviation for ânumber only used onceâ. Miners compete in a Proof-of-Work based blockchain network to find the targeted hash. In addition, every Ethereum account has a incremental nonce to prevent replay attack. </div>
                </div>
            </div>
...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center">
    <li >
     <a class="page-link" href="etherlimeTheory2.jsp">Previous</a>
    </li>
