...
<div class="container" style = background-color : "white">
   <div class="row ">
   <div class="w-100">
   <h3 align="center">Freameworks</h3>
   <p align="center">
      <!-- SO Large Rect Start -->
<!--SO Large Rect -->
   </p><p></p><p></p>
  ...
  <table class="table table-hover table-bordered " >
      <tbody>
  <tr><td><a href="Angular2optionsView.jsp">Angular</a>
...
<br>Angular is a modular and scalable framework that, given that it’s based on web components standard, allows you to encapsulate individual custom HTML elements you can later reuse at your will. Additionally, Angular is open source, which means you’ll have enough flexibility to tackle your projects with it, and a huge community with many available resources you can turn for help. 

      </div>
    </div>
  </div></td></tr>
<tr><td><a href="Asp.Net2optionsView.jsp">Asp.Net</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
      ...
      <br>ASP.NET Core, for its part, is a redesign of earlier Windows-only versions of ASP.NET – and an open-source alternative at that. Both ASP.NET and ASP.NET Core are great for web developers building modern web and services and use Windows, Linux, macOS, or Docker to do so. 
     
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="Express2optionsView.jsp">Express</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
...
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      ...
      <br>At its most basic level, Vue is fantastic to build user interfaces. But if you combine it with modern tooling and supporting libraries, you can also use it to create complex and sophisticated Single-Page Applications. 
...
<tr><td><a href="Spring2optionsView.jsp">Spring</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
      ...
      <br>Its use in web development comes from its own MCV, which the Spring developers included in the framework to overcome the shortcomings of Struts and other popular alternatives. 
      
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="Django2optionsView.jsp">Django</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       ...
       <br>Apart from using one of the most widely used programming languages out there, Django is a developer’s favorite because of the increasing security level it provides your apps right out of the box. Also, this framework is highly flexible and scalable, which allows you to easily build web apps in no time regardless of their complexity.  
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="Flask2optionsView.jsp">Flask</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
        ...
        <br>That’s the main reason why Flask is considered a microframework – it doesn’t provide common functionalities with pre-built libraries. You only add the extensions you need for the web development project at hand, which keeps things small, lightweight, and easily manageable, advantages that can be a charm for certain developers. 
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="Laravel2optionsView.jsp">Laravel</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       ...
       <br>Thus, you can use Laravel to simplify your web development by using its built-in capabilities for authentication, caching, sessions, and routing, among others. Besides, you can use its integrated unit testing support to make sure all your apps are up to the challenge. 
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="RubyOnRails2optionsView.jsp">Ruby on rails</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       ...
       <br>Thanks to its object-oriented nature and its focus on data safety, tool integration, and innovation, Rails is the choice of many web developers that want to build custom platforms, ecommerce stores, SaaS systems, and APIs. 
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="Symfony2optionsView.jsp">Symfony</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
      ...
      <br>So, Symfony is a collection of those components you can use to develop applications and websites in PHP. It offers good performance and helps you come up with well-structured, maintainable, and scalable code. 
      
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="CakePhp2optionsView.jsp">CakePHP</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       ...
       <br>CakePHP lets you build quickly by using code generation and scaffolding, which is great to create prototypes fast. And since this framework follows a set of predefined conventions, you can be sure it’ll guide you throughout development towards a successful product that not just performs well but that’s also highly secure. 
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="Zend2optionsView.jsp">Zend</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
        ...
        <br>Zend is a highly performance-oriented framework that’s enterprise-ready. That means that you can use it to develop high-usage apps for critical business processes without worrying about its efficiency. Best of all, Zend is a very secure framework, as it follows the best and latest security practices. 
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="BootStrap2optionsView.jsp">Bootstrap</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       ...
       <br>You can use it to simplify the development of informative web pages, as it allows you to easily customize the frontend and ensure that the web’s components are displayed in the same way across web browsers. And then there are Bootstrap’s layout components that you can accommodate to your requirements. 
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="Grails2optionsView.jsp">Grails</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
      ...
      <br>Grails seamlessly integrates with Java, the JVM, and Java EE containers and can even be extended through plugins to enhance it even more. As if that wasn’t enough, this framework also uses application profiles, which allows you to develop RESTAPIs and web apps with a JavaScript frontend. 
      
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="Play2optionsView.jsp">Play</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
     ...
     <br>One of the biggest benefits of using Play is that its resulting applications have a very low resource consumption, thanks to the framework’s lightweight, stateless, and web-friendly architecture. What’s more – Play’s apps can also scale both horizontally and vertically, thanks to its reactive model. 
     
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="Web2py2optionsView.jsp">Web2py</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
        ...
        <br>As a result, Web2py allows you to develop scalable and secure database-driven web-based applications in a fast way. Another thing that’s worth mentioning about this framework is that it works through a web-based IDE, which means that you can create, deploy, and manage your apps from anywhere in the world just by using your browser. 
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="Lumen2optionsView.jsp">Lumen</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
...
<tr><td><a href="FuelPHP2optionsView.jsp">FuelPHP</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
...
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
        ...
        <br>What’s more, Spark is a great alternative for microservices, since it can help you create your REST APIs and ready to serve JSON in just a couple of lines. And that’s not all, it also supports template engines to create both backend and frontend applications in a flash. 
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="Fat-Free2optionsView2.jsp">Fat-Free Framework</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       ...
       <br>Now, the fact that this is a microframework doesn’t necessarily translate into limitations. In fact, the Fat-Free Framework is very powerful under the hood. That’s because it includes a multiprotocol cache engine, URL routing, and built-in code highlighting, among many other things. 
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="Wicket2optionsView.jsp">Wicket</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
        ...
        <br>You can use Wicket to develop pretty much any website or application you imagine. And you can do it with peace of mind, as Wicket comes with full support for CSP and a series of security features that will keep your model private wherever you need. 
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="SenchaExtJs2optionsView.jsp">Sencha Ext JS</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
...
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       ...
       <br>A nice feature in Protractor is automatic waiting, which is nothing more than the automatic execution of steps in a test once pending tasks are done. This way, you don’t have to monitor whether your tests and webpage are syncing, as Protractor will do that for you. 
      </div>
    </div>
  </div></td></tr>
<tr><td><a href="Cypress1optionsView.jsp">Cypress</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
...
<tr><td><a href="Etherlime1optionsView.jsp">Etherlime</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
...
<tr><td><a href="Corda1optionsView.jsp">Corda</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
...
<tr><td><a href="Meteor1optionsView.jsp">Meteor</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
...
<tr><td><a href="Electron1optionsView.jsp">Electron</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
...
<tr><td><a href="Aurelia1optionsView.jsp">Aurelia</a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
